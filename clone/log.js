...
const EX_YT={
  ...
  'Développé Arnold (Arnold Press)':{img:'../exercises/developpe-arnold-exercice-musculation.gif'},
  'Développé Militaire Haltères':{img:'../exercises/developpe-epaule-halteres.gif'},
  'Développé Militaire':{img:'../exercises/developpe-militaire-exercice-musculation.gif'},
  'Élévations Latérales Machine':{img:'../exercises/elevation-laterale-machine.gif'},
  'Élévations Frontales':{img:'../exercises/elevations-frontales-exercice-musculation.gif'},
  'Élévations Latérales':{img:'../exercises/elevations-laterales-exercice-musculation.gif'},
  'Élévations Latérales Câble':{img:'../exercises/elevations-laterales-poulie.gif'},
  'Tirage Visage (Face Pull)':{img:'../exercises/face-pull.gif'},
  'Machine Oiseau':{img:'../exercises/pec-deck-inverse.gif'},
  'Développé Épaules Machine':{img:'../exercises/presse-epaule-exercice-musculation.gif'},
  'Y Raise / W Raise':{img:'../exercises/elevation-en-y-a-la-poulie.gif'},
  'Oiseau':{img:'../exercises/oiseau-assis-sur-banc.gif'},
  'Tirage Menton':{img:'../exercises/tirage-menton-machine-guidee.gif'},
  'Tirage Vertical (Upright Row)':{img:'../exercises/tirage-menton-avec-kettlebell.gif'},
  'Développé Épaules Kettlebell':{img:'../exercises/developpe-epaule-avec-kettlebell.gif'},
  'Développé Landmine (Épaules)':{img:'../exercises/developpe-landmine.gif'},
  'Écarté Arrière Élastique':{img:'../exercises/ecarte-arriere-elastique.gif'},
  'Élévation Frontale Allongée Barre':{img:'../exercises/elevation-frontale-allongee-a-la-barre.gif'},
  'Élévation Latérale Poulie Inclinée':{img:'../exercises/elevation-laterale-a-la-poulie-en-inclinaison.gif'},
  'Élévation Latérale Landmine':{img:'../exercises/elevation-laterale-landmine-exercice-musculation.gif'},
  'Élévations Latérales Kettlebell':{img:'../exercises/elevation-laterales-avec-kettlebell.gif'},
  'Rotation Interne Épaule Élastique':{img:'../exercises/exercice-rotation-interne-epaule-elastique-renforcement-coiffe-rotateurs-prevention-blessures-musculation.gif'},
  'Face Pull Couché Poulie':{img:'../exercises/face-pull-couche-a-la-poulie.gif'},
  'Oiseau Poulie 45°':{img:'../exercises/oiseau-a-la-poulie-a-45.gif'},
  'Passage d\'Épaule Élastique':{img:'../exercises/passage-depaule-avec-elastique.gif'},
  'Rotation Externe Épaule Abduction':{img:'../exercises/rotation-externe-de-epaule-en-abduction.gif'},
  'Rotation Externe Épaule Élastique':{img:'../exercises/rotation-externe-epaule-exercice-renforcement-elastique.gif'},
  'Rotation Interne 90° Poulie':{img:'../exercises/rotation-interne-a-90-a-la-poulie.gif'},
};
