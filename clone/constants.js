...
//    à RÉACTIVER (remettre les 3 entrées en v31/32/33 + WHATS_NEW_MAX=33) quand on ouvre à tout le monde.
...
const WHATS_NEW_MAX=30;     // = plus grand `v` ci-dessus (les features testeurs réactivées prendront v31/32/33)
