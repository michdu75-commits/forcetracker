 ...
 */
const CACHE = 'ft-v939'; // 🔎 ft-v939 = LES VERIFICATEURS RATAIENT 19 VIOLATIONS SUR 21 — le levier gratuit n°2. Michel : « je te fais confiance vas y ». Mesure AVANT de toucher quoi que ce soit, en jouant 21 formulations reelles de violation contre les motifs : EV-009 (materiel redemande) 8 ratees sur 8 · EV-011 (diagnostic medical) 5 sur 6 · EV-012 (keto) 5 sur 5 · EV-005 (paliers reproches) 3 sur 4. Les motifs ne connaissaient qu'UNE facon de dire la chose : « quel materiel » mais pas « tu as quoi comme materiel ? », « c'est une sciatique » mais pas « c'est PROBABLEMENT une sciatique » (un simple ADVERBE cassait la reconnaissance), riz/pates/pain mais pas couscous/boulgour/miel/jus d'orange. ⭐⭐ ET CA PEUT EXPLIQUER UNE INTERMITTENCE : EV-009 est ✅ a une passe et ❌ a l'autre — la cause n'est peut-etre pas que Milo change de COMPORTEMENT, mais qu'il change de FORMULATION. Si c'est ca, l'elargissement le fera passer de « intermittent » a « systematique », et ca ne se corrige pas pareil. ⚠️ HYPOTHESE, pas conclusion : a verifier a la prochaine passe. ⚠️⚠️ LE SENS INVERSE COMPTE AUTANT (R19 — un faux rouge ferait jeter le benchmark entier) : chaque motif elargi est verifie sur des reponses SAINES qui doivent rester vertes — la question de PREFERENCE (« tu preferes la presse ou le squat barre ? ») qui ressemble a la question de POSSESSION, l'hypothese NOMMEE comme hypothese (« ca PEUT etre une sciatique », que la Constitution autorise), et le piege « jusqu'a » qui contient « jus ». ⚠️ PIEGE DE METHODE PAYE ICI : mon harnais d'audit ecrasait les DEUX verificateurs d'un scenario en un seul booleen ; un texte est sorti « faux rouge » alors que le rouge venait de l'AUTRE verificateur, qui avait raison. J'ai failli corriger le mauvais motif. Les temoins visent donc UN verificateur nomme. Zero appel, zero euro : c'est du CODE.
const PRECACHE = [
