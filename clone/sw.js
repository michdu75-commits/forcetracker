 ...
 */
const CACHE = 'ft-v966'; // 🧮 ft-v966 = « POUR TES 30 G » — deux nombres de proteines sur le meme ecran, rien ne disait lequel etait le sien. Michel a lu « 88 g » sur la carte produit et a cru que c'etait son apport. ⭐ SA VIDEO A MONTRE QUE L'APP AVAIT ENTIEREMENT RAISON : Quantite 30 g, champs a 117 kcal / 26 g de proteines — exact au gramme pres. Le 88 est la carte Open Food Facts, titree « Valeurs pour 100 g ». ⛔⛔ AUCUN DES DEUX NOMBRES N'EST FAUX — c'est leur VOISINAGE MUET qui trompe, et c'est plus vicieux qu'une erreur : il n'y a rien a corriger, donc rien ne se signale. Le 88 est en vert vif et en gros, ses vrais 26 g vivaient beaucoup plus bas, hors ecran. ⭐ LA LIGNE VA DANS LA RANGEE QUANTITE, pas dans la carte : c'est la que se porte l'attention au moment ou l'on regle les grammes. ⭐⭐ R2 — ELLE NE CALCULE RIEN : elle RELIT les champs que `_bcApplyGrams` vient d'ecrire. Deux calculs du meme nombre finiraient par diverger, et on ne saurait plus lequel croire. ⛔ Elle n'affiche JAMAIS la valeur pour 100 g (temoin dedie), et disparait si la quantite est vide plutot que d'annoncer « pour tes 0 g ». ⚠️⚠️ ET CETTE VERSION CORRIGE UNE FAUSSE CAUSE DE LA MIENNE : ft-v965 affirmait que la quantite etait restee a 100. C'ETAIT FAUX. J'avais deduit le mecanisme d'un SEUL NOMBRE (88 = 100 g d'une poudre a 88 g/100 g) sans demander l'ecran, et la coincidence parfaite rendait la fausse cause credible. Le deplacement du champ reste bon, la RAISON ecrite a cote etait inventee — corrige dans le journal en le DISANT (R23/R27), et nouvelle famille BUGS.md 12quater.
const PRECACHE = [
