 ...
 */
const CACHE = 'ft-v922'; // 💪 ft-v922 = LES GROUPES MUSCULAIRES AU PROPRE — 3 scissions, 19 → 22 codes. Michel : « il faut que les groupes musculaires soient au top ». Mesure d'abord : 13 groupes sur 19 regroupaient plusieurs muscles distincts, et DEUX rendaient identiques des exercices que personne ne confond en salle. ① MOLLETS DEBOUT vs ASSIS rendaient tous deux `calves:2` — or debout = jumeaux (genou tendu), assis = SOLEAIRE (genou flechi). Le cas d'ecole. ② CURL vs EXTENSION DE POIGNET rendaient tous deux `forearms:2` — jumeau EXACT de l'adducteur livre le matin meme : deux mouvements opposes, un seul resultat. ③ Le DENTELE ANTERIEUR etait range dans les OBLIQUES : ce n'est pas de l'imprecision, c'est un MAUVAIS RANGEMENT — il plaque l'omoplate (pompes, pull-over), les obliques font tourner le tronc. ⭐⭐ LE CRITERE QUI REND CES TROIS SCISSIONS SURES, et qui n'est PAS la finesse anatomique : le RESTE du groupe garde son sens sans la partie qu'on sort. Les 93 fiches « avant-bras » parlent de la PRISE (flechisseurs), les 62 fiches « mollets » en secondaire parlent des jumeaux, les 30 fiches d'obliques ne travaillent pas le dentele. Cout reel : 18 fiches reprises sur 334, pas 194. ⚠️ Les trois muscles etaient DEJA DESSINES — R31, la figurine est le vocabulaire. ⚠️ Et les 2 nouvelles regles de repli sont placees DEVANT les generales, pas derriere (le « premier match gagnant », leçon de ft-v921 le matin meme). ⛔ NON FAIT, et ecrit : pectoral haut/milieu/bas (55 fiches) et moyen fessier (108) — la scission n'y est PAS propre, il faudrait relire tous les developpes et tous les squats. C'est l'arbitrage de Michel, pas un effet de bord.
const PRECACHE = [
