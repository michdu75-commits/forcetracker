...
## Principe 21 — Une donnée ne doit jamais coûter plus qu'elle n'apporte
**Aucun suivi, aucune donnée, aucune fonctionnalité** ne doit devenir une **source de
stress, de charge mentale ou de culpabilité supérieure au bénéfice qu'elle apporte.** Le but
n'est **pas** d'obtenir le MAXIMUM de données, mais **suffisamment** pour prendre la meilleure
décision possible **tout en conservant une excellente expérience**. Si une métrique nuit au
sommeil, à la régularité ou au moral, elle est **contre-productive** → l'app l'allège ou la masque.

Application phare — la **nutrition** :
...
- La nutrition est un **levier au service de l'objectif**, jamais une finalité.
- **La précision est un CHOIX**, jamais une obligation (qualitatif → portions → macros →
  suivi précis) — c'est la pertinence appliquée à la profondeur de suivi.
- Elle **améliore** le coaching, ne le **conditionne** jamais (« répondre d'abord, proposer
  ensuite », P19).

Prolonge le Principe 17 (l'accompagnement, jamais la thérapie), le Principe 19 (la pertinence)
et le Principe 20 (la cohérence). *(Phrase de Michel, 22/07/2026 — croisement GPT + Gemini +
Mistral + Claude sur l'esprit nutrition ; détail : `docs/NUTRITION-PHILOSOPHIE.md`.)*
