...
(function(){
  ...
  var TR = {
    ...
    // ══════════════════════════════════════════════════════════════════════════════
    // 🏋️ LES 324 NOMS D'EXERCICES (ajoutés le 11/08/2026)
    //
    // L'interface parlait déjà russe (252 textes) — mais le CATALOGUE restait en français.
    // Pour une personne russophone, l'écran Séance, le sélecteur d'exercices et l'historique
    // s'affichaient donc en français : justement la partie qu'on lit le plus.
    //
    // ⚠️ SEULE LA LANGUE D'AFFICHAGE CHANGE. Le nom STOCKÉ dans les données reste le nom
    // FRANÇAIS (`ex.name`) : historique, records, reconnaissance d'exercices et figurines
    // continuent de fonctionner à l'identique, et une séance enregistrée en russe se relit en
    // français. Rien à migrer, aucun risque sur les données. (Vérifié avant d'écrire : rien
    // dans l'app ne RELIT un nom d'exercice depuis l'écran — que des écritures.)
    //
    // ⚠️ Traduction faite par Claude, PAS par un russophone natif. Les mouvements de base sont
    // sûrs (жим лёжа, приседания со штангой, становая тяга = le vocabulaire standard des salles
    // russes) ; les variantes rares méritent une relecture. Vérifié automatiquement : les 324
    // sont couverts, aucun ne partage son nom russe avec un autre (deux entrées identiques dans
    // le sélecteur seraient pires que le français), aucun n'a gardé un mot français par mégarde.
    //
    // Les 4 autres langues retombent volontairement sur le français : `window.t` fait ce repli,
    // et un nom français lisible vaut mieux qu'un anglais approximatif.
    "Abduction Cuisses (Leg Abduction)":{ru:"Разведение ног в тренажере"},
    "Adduction Cuisses (Leg Adduction)":{ru:"Сведение ног в тренажере"},
    "Arraché Debout (Muscle Snatch)":{ru:"Силовой рывок стоя"},
    "Arraché Haltère (Dumbbell Snatch)":{ru:"Рывок гантели"},
    "Assault Air Bike":{ru:"Эйр-байк"},
    "Barre au Front":{ru:"Французский жим лёжа"},
    "Battle Rope":{ru:"Канаты (battle rope)"},
    "Belt Squat":{ru:"Приседания с поясом"},
    "Bench Dips":{ru:"Обратные отжимания от скамьи"},
    "Bird Dog":{ru:"Упражнение «птица-собака»"},
    "Box Jump":{ru:"Запрыгивания на тумбу"},
    "Burpees":{ru:"Бёрпи"},
    "Chaise (Wall Sit)":{ru:"Стульчик у стены"},
    "Chaise Romaine":{ru:"Подъём ног на римском стуле"},
    "Chariot de Puissance — Curl Biceps":{ru:"Сгибание на бицепс с санями"},
    "Chariot de Puissance — Extension Triceps":{ru:"Разгибание на трицепс с санями"},
    "Chariot de Puissance — Fentes Arrière":{ru:"Обратные выпады с санями"},
    "Chariot de Puissance — Poussée":{ru:"Толкание силовых саней"},
    "Chariot de Puissance — Tirage Dos":{ru:"Тяга саней на спину"},
    "Chariot de Puissance — Tirage Inversé Jambes":{ru:"Обратная тяга саней ногами"},
    "Chariot de Puissance — Tirage de Côté":{ru:"Боковая тяга саней"},
    "Chariot de Puissance — Tirage en Avançant":{ru:"Тяга саней с продвижением"},
    "Chariot de Puissance — Tirage Épaules":{ru:"Тяга саней на плечи"},
    "Chest Press Machine Déclinée":{ru:"Жим в тренажере головой вниз"},
    "Chest Press Machine Horizontale":{ru:"Жим от груди в тренажере"},
    "Chest Press Machine Inclinée":{ru:"Жим в тренажере на наклонной скамье"},
    "Chest Press Poulie Assis":{ru:"Жим от груди сидя в кроссовере"},
    "Chest Press TRX (Sangles)":{ru:"Жим от груди в TRX"},
    "Clean & Jerk":{ru:"Толчок (взятие на грудь и толчок)"},
    "Cossack Squat":{ru:"Казацкие приседания"},
    "Croisé Poulie (Cable Crossover)":{ru:"Сведение рук в кроссовере (кроссовер)"},
    "Croix de Fer Haltères":{ru:"Железный крест с гантелями"},
    "Crunch":{ru:"Скручивания"},
    "Crunch Machine":{ru:"Скручивания в тренажере"},
    "Crunch Poulie":{ru:"Скручивания на блоке"},
    "Curl Araignée (Spider Curl)":{ru:"Подъём на бицепс на наклонной скамье лицом вниз"},
    "Curl Barre":{ru:"Подъём штанги на бицепс"},
    "Curl Concentré":{ru:"Концентрированный подъём на бицепс"},
    "Curl EZ":{ru:"Подъём EZ-грифа на бицепс"},
    "Curl Haltères":{ru:"Подъём гантелей на бицепс"},
    "Curl Incliné":{ru:"Подъём гантелей на наклонной скамье"},
    "Curl Poignet Barre":{ru:"Сгибание запястий со штангой"},
    "Curl Poulie":{ru:"Сгибание рук на блоке"},
    "Curl Pupitre Barre EZ (Larry Scott)":{ru:"Подъём на скамье Скотта с EZ-грифом"},
    "Curl Pupitre Machine":{ru:"Сгибание рук в тренажере (парта)"},
    "Curl Zottman":{ru:"Подъём Зоттмана"},
    "Dips":{ru:"Отжимания на брусьях"},
    "Dips Assis Machine (Seated Dip)":{ru:"Отжимания сидя в тренажере"},
    "Dips Machine Assistée":{ru:"Отжимания на брусьях в гравитроне"},
    "Dips Triceps (Buste Droit)":{ru:"Отжимания на брусьях на трицепс"},
    "Dips aux Anneaux":{ru:"Отжимания на кольцах"},
    "Dips entre Deux Bancs":{ru:"Обратные отжимания между скамьями"},
    "Drapeau (Dragon Flag)":{ru:"Флажок дракона"},
    "Développé Arnold (Arnold Press)":{ru:"Жим Арнольда"},
    "Développé Couché":{ru:"Жим лёжа"},
    "Développé Couché Haltères":{ru:"Жим гантелей лёжа"},
    "Développé Couché Larsen (Larsen Press)":{ru:"Жим Ларсена"},
    "Développé Couché Unilatéral Kettlebell":{ru:"Жим гири лёжа одной рукой"},
    "Développé Couché au Sol (Floor Press)":{ru:"Жим лёжа на полу"},
    "Développé Couché avec Chaînes":{ru:"Жим лёжа с цепями"},
    "Développé Couché Élastique":{ru:"Жим лёжа с резинкой"},
    "Développé Décliné":{ru:"Жим лёжа головой вниз"},
    "Développé Décliné Haltères":{ru:"Жим гантелей головой вниз"},
    "Développé Décliné Élastique":{ru:"Жим с резинкой головой вниз"},
    "Développé Haltères Assis":{ru:"Жим гантелей сидя"},
    "Développé Incliné":{ru:"Жим лёжа на наклонной скамье"},
    "Développé Incliné Haltères":{ru:"Жим гантелей на наклонной скамье"},
    "Développé Incliné Poulie":{ru:"Жим на наклонной скамье в кроссовере"},
    "Développé Landmine (Épaules)":{ru:"Жим на плечи с грифом в упоре"},
    "Développé Militaire":{ru:"Армейский жим стоя"},
    "Développé Militaire Haltères":{ru:"Жим гантелей стоя"},
    "Développé Nuque":{ru:"Жим из-за головы"},
    "Développé Épaules Assis Machine (Shoulder Press)":{ru:"Жим на плечи сидя в тренажере"},
    "Développé Épaules Assis Élastique":{ru:"Жим на плечи сидя с резинкой"},
    "Développé Épaules Kettlebell":{ru:"Жим гири на плечи"},
    "Développé Épaules Machine":{ru:"Жим на плечи в тренажере"},
    "Développé Épaules Unilatéral Élastique":{ru:"Жим на плечи одной рукой с резинкой"},
    "Développé Épaules Élastique":{ru:"Жим на плечи с резинкой"},
    "Ergomètre de Ski (Ski Erg)":{ru:"Лыжный эргометр"},
    "Extension Fessiers Arrière (Kickback)":{ru:"Отведение ноги назад (кикбэк)"},
    "Extension Lombaire sur Ballon":{ru:"Разгибание спины на фитболе"},
    "Extension Nuque Haltère":{ru:"Разгибание рук с гантелей из-за головы"},
    "Extension Nuque Poulie Haute":{ru:"Разгибание рук из-за головы в кроссовере"},
    "Extension Poignet Barre":{ru:"Разгибание запястий со штангой"},
    "Extension Quadriceps (Leg Extension)":{ru:"Разгибание ног в тренажере"},
    "Extension Quadriceps Unilatérale":{ru:"Разгибание одной ноги в тренажере"},
    "Extension Quadriceps Unilatérale Machine à Dips":{ru:"Разгибание одной ноги на брусьях"},
    "Extension Quadriceps Élastique":{ru:"Разгибание ног с резинкой"},
    "Extension Triceps":{ru:"Разгибание рук на трицепс"},
    "Extension Triceps Allongée TRX (Sangles)":{ru:"Французский жим в TRX"},
    "Extension Triceps Arrière (Kickback)":{ru:"Разгибание руки в наклоне (кикбэк)"},
    "Extension Triceps Banc Incliné Haltères":{ru:"Французский жим гантелей на наклонной скамье"},
    "Extension Triceps Concentrée Poulie":{ru:"Концентрированное разгибание на блоке"},
    "Extension Triceps Couché Haltères":{ru:"Французский жим гантелей лёжа"},
    "Extension Triceps Décliné Haltères":{ru:"Французский жим гантелей головой вниз"},
    "Extension Triceps Nuque Élastique":{ru:"Разгибание рук из-за головы с резинкой"},
    "Extension Triceps TRX (Sangles)":{ru:"Разгибание рук на трицепс в TRX"},
    "Extension Triceps Verticale Élastique":{ru:"Разгибание рук вниз с резинкой"},
    "Face Pull Couché Poulie":{ru:"Тяга к лицу лёжа на блоке"},
    "Farmer's Walk":{ru:"Прогулка фермера"},
    "Fentes":{ru:"Выпады"},
    "Fentes Arrière":{ru:"Обратные выпады"},
    "Fentes Croisées (Curtsy Lunge)":{ru:"Выпады реверанс"},
    "Fentes Kettlebell":{ru:"Выпады с гирей"},
    "Fentes Latérales":{ru:"Боковые выпады"},
    "Fentes Marchées":{ru:"Выпады в движении"},
    "Gainage":{ru:"Планка на предплечьях"},
    "Glute Ham Raise (GHD)":{ru:"Сгибания ног на GHD"},
    "Grimpeur (Mountain Climber)":{ru:"Скалолаз"},
    "Hack Squat Assis":{ru:"Гакк-приседания сидя"},
    "Hack Squat Inversé":{ru:"Обратные гакк-приседания"},
    "Handstand Push-up (ATR)":{ru:"Отжимания в стойке на руках"},
    "Handstand Push-up Suspendu (Sangles)":{ru:"Отжимания в стойке на руках в петлях"},
    "Haussements d'Épaules Barre":{ru:"Шраги со штангой"},
    "Haussements d'Épaules Câble":{ru:"Шраги на блоке"},
    "Haussements d'Épaules Haltères":{ru:"Шраги с гантелями"},
    "Haussements d'Épaules Overhead":{ru:"Шраги над головой"},
    "Hex Press Smith Machine":{ru:"Жим гантелей вместе в Смите"},
    "Hip Thrust Barre (Poussée de Hanche)":{ru:"Ягодичный мост со штангой"},
    "Hip Thrust Haltère (Poussée de Hanche)":{ru:"Ягодичный мост с гантелей"},
    "Hip Thrust Machine (Poussée de Hanche)":{ru:"Ягодичный мост в тренажере"},
    "Hip Thrust Unilatéral (Poussée de Hanche)":{ru:"Ягодичный мост на одной ноге"},
    "Hollow Body":{ru:"Полая позиция (hollow body)"},
    "Hyperextension (Back Extension)":{ru:"Гиперэкстензия"},
    "Hyperextension Inverse (Reverse Hyper)":{ru:"Обратная гиперэкстензия"},
    "Hyperextension Lestée":{ru:"Гиперэкстензия с отягощением"},
    "Hyperextension Machine":{ru:"Гиперэкстензия в тренажере"},
    "Inclinaison Lombaire (Good Morning)":{ru:"Наклоны со штангой («доброе утро»)"},
    "Jefferson Curl":{ru:"Джефферсон-курл"},
    "Jefferson Squat":{ru:"Приседания Джефферсона"},
    "Jumping Jack":{ru:"Прыжки «звёздочка»"},
    "Kettlebell Swing":{ru:"Махи гирей"},
    "Kickback Machine":{ru:"Отведение ноги назад в тренажере"},
    "Leg Curl Assis Machine":{ru:"Сгибание ног сидя"},
    "Leg Curl Couché Machine":{ru:"Сгибание ног лёжа"},
    "Leg Curl Haltère":{ru:"Сгибание ног с гантелей"},
    "Leg Curl Inversé":{ru:"Обратное сгибание ног"},
    "Leg Curl Unilatéral Debout":{ru:"Сгибание одной ноги стоя"},
    "Leg Curl Élastique":{ru:"Сгибание ног с резинкой"},
    "Machine Oiseau":{ru:"Обратная бабочка (задняя дельта)"},
    "Marche de l'Ours (Bear Crawl)":{ru:"Медвежья походка"},
    "Marteau":{ru:"Молотковый подъём на бицепс"},
    "Meadows Row":{ru:"Тяга Мидоуса"},
    "Mollets Machine Assise":{ru:"Подъёмы на носки сидя в тренажере"},
    "Mollets Machine Debout":{ru:"Подъёмы на носки стоя в тренажере"},
    "Montée sur Box (Step-up)":{ru:"Зашагивания на платформу"},
    "Montée sur Box Haltères":{ru:"Зашагивания на платформу с гантелями"},
    "Muscle-up":{ru:"Выход силой"},
    "Oiseau":{ru:"Разведение гантелей в наклоне"},
    "Oiseau Inversé TRX (Sangles)":{ru:"Обратное разведение рук в TRX"},
    "Oiseau Poulie 45°":{ru:"Разведение в наклоне 45° на блоке"},
    "Oiseau Élastique":{ru:"Разведение рук в наклоне с резинкой"},
    "Overhead Squat":{ru:"Приседания со штангой над головой"},
    "Overhead Squat Haltères":{ru:"Приседания с гантелями над головой"},
    "Overhead Squat Élastique":{ru:"Приседания с резинкой над головой"},
    "Passage d'Épaule Élastique":{ru:"Выкруты плеч с резинкой"},
    "Pec Deck":{ru:"Сведение рук в тренажере (бабочка)"},
    "Pendulum Squat":{ru:"Маятниковые приседания"},
    "Pin Squat":{ru:"Приседания с упоров"},
    "Planche Inversée":{ru:"Обратная планка"},
    "Planche Latérale (Side Plank)":{ru:"Боковая планка"},
    "Planche de Préhension":{ru:"Тренировка хвата на доске"},
    "Pompes (Push-up)":{ru:"Отжимания от пола"},
    "Pompes Diamant":{ru:"Отжимания узким хватом (алмазные)"},
    "Pompes Déficit (Deficit Push-up)":{ru:"Отжимания с увеличенной амплитудой"},
    "Pompes Inclinées TRX (Sangles)":{ru:"Отжимания в TRX"},
    "Pompes Lestées":{ru:"Отжимания с отягощением"},
    "Pont Fessier (Glute Bridge)":{ru:"Ягодичный мостик"},
    "Press Jambes 45°":{ru:"Жим ногами под 45°"},
    "Press Jambes Horizontale":{ru:"Горизонтальный жим ногами"},
    "Press Jambes Inclinée":{ru:"Наклонный жим ногами"},
    "Press Jambes Levier":{ru:"Рычажный жим ногами"},
    "Press Jambes Verticale":{ru:"Вертикальный жим ногами"},
    "Presse Mollets (Leg Press)":{ru:"Подъёмы на носки в жиме ногами"},
    "Presse à Cuisses Iso-Latérale":{ru:"Изолатеральный жим ногами"},
    "Presse à Cuisses sur le Côté":{ru:"Жим ногами лёжа на боку"},
    "Pronation Supination Haltère":{ru:"Пронация-супинация с гантелей"},
    "Pull-over":{ru:"Пуловер"},
    "Pull-over Barre":{ru:"Пуловер со штангой"},
    "Pull-over Haltère":{ru:"Пуловер с гантелей"},
    "Pull-over Poulie":{ru:"Пуловер на верхнем блоке"},
    "Pullover Machine":{ru:"Пуловер в тренажере"},
    "Reeves Deadlift":{ru:"Становая тяга Ривза"},
    "Relevé de Jambes":{ru:"Подъём ног в висе"},
    "Renegade Row":{ru:"Тяга гантели в упоре лёжа"},
    "Rocky Pull-up":{ru:"Подтягивания «Рокки»"},
    "Rotation Externe Épaule Abduction":{ru:"Наружная ротация плеча в отведении"},
    "Rotation Externe Épaule Haltère":{ru:"Наружная ротация плеча с гантелей"},
    "Rotation Externe Épaule Poulie":{ru:"Наружная ротация плеча на блоке"},
    "Rotation Externe Épaule Élastique":{ru:"Наружная ротация плеча с резинкой"},
    "Rotation Interne 90° Poulie":{ru:"Внутренняя ротация 90° на блоке"},
    "Rotation Interne Épaule Élastique":{ru:"Внутренняя ротация плеча с резинкой"},
    "Rotation Machine Obliques":{ru:"Повороты корпуса в тренажере"},
    "Rotation Russe (Russian Twist)":{ru:"Русские скручивания"},
    "Roue Abdominale (Ab Wheel)":{ru:"Ролик для пресса"},
    "Rowing Barre (Tirage Horizontal)":{ru:"Тяга штанги в наклоне"},
    "Rowing Buste Penché Élastique":{ru:"Тяга резинки в наклоне"},
    "Rowing Câble (Tirage Horizontal)":{ru:"Тяга нижнего блока"},
    "Rowing Haltère (Tirage Horizontal)":{ru:"Тяга гантели в наклоне одной рукой"},
    "Rowing Haltères Buste Penché":{ru:"Тяга гантелей в наклоне"},
    "Rowing Hammer Strength":{ru:"Рычажная тяга Hammer Strength"},
    "Rowing Horizontal Élastique":{ru:"Горизонтальная тяга с резинкой"},
    "Rowing Inversé sous une Table":{ru:"Австралийские подтягивания под столом"},
    "Rowing Landmine (T-Bar)":{ru:"Т-тяга с грифом в упоре"},
    "Rowing Machine (Tirage Horizontal)":{ru:"Горизонтальная тяга в тренажере"},
    "Rowing Poitrine Appuyée (Chest Supported)":{ru:"Тяга с упором грудью"},
    "Rowing Smith Machine":{ru:"Тяга в Смите в наклоне"},
    "Rowing T-Bar Machine":{ru:"Т-тяга в тренажере"},
    "Rowing TRX (Sangles)":{ru:"Тяга в TRX"},
    "Rowing Unilatéral Élastique":{ru:"Тяга резинки одной рукой"},
    "Rowing Yates (Supination)":{ru:"Тяга Йейтса обратным хватом"},
    "Russian Twist Développé Épaules":{ru:"Русский твист с жимом над головой"},
    "Safety Bar Squat":{ru:"Приседания с safety-грифом"},
    "Sauts à la Corde":{ru:"Прыжки на скакалке"},
    "Seal Row":{ru:"Тяга лёжа на скамье"},
    "Sissy Squat":{ru:"Сисси-приседания"},
    "Sissy Squat Machine":{ru:"Сисси-приседания в тренажере"},
    "Skull Crusher Barre EZ":{ru:"Французский жим с EZ-грифом"},
    "Sled Pull":{ru:"Тяга саней"},
    "Sled Push":{ru:"Толкание саней"},
    "Smith Machine Développé Couché":{ru:"Жим лёжа в Смите"},
    "Smith Machine Développé Incliné":{ru:"Жим в Смите на наклонной скамье"},
    "Smith Machine Développé Militaire":{ru:"Армейский жим в Смите"},
    "Smith Machine Fentes":{ru:"Выпады в Смите"},
    "Smith Machine Squat":{ru:"Приседания в Смите"},
    "Soulevé de Terre":{ru:"Становая тяга"},
    "Soulevé de Terre Jambes Tendues":{ru:"Становая тяга на прямых ногах"},
    "Soulevé de Terre Machine":{ru:"Становая тяга в тренажере"},
    "Soulevé de Terre Roumain Barre":{ru:"Румынская тяга со штангой"},
    "Soulevé de Terre Roumain Haltères":{ru:"Румынская тяга с гантелями"},
    "Soulevé de Terre Roumain Kettlebell":{ru:"Румынская тяга с гирей"},
    "Soulevé de Terre Roumain Landmine":{ru:"Румынская тяга с грифом в упоре"},
    "Soulevé de Terre Roumain Unilatéral":{ru:"Румынская тяга на одной ноге"},
    "Soulevé de Terre Sumo":{ru:"Становая тяга сумо"},
    "Soulevé de Terre Sumo Haltères":{ru:"Тяга сумо с гантелями"},
    "Soulevé de Terre Sumo Kettlebell":{ru:"Тяга сумо с гирей"},
    "Soulevé de Terre Sumo Landmine":{ru:"Тяга сумо с грифом в упоре"},
    "Soulevé de Terre Trap Bar":{ru:"Становая тяга с трэп-грифом"},
    "Soulevé de Terre Valise (Suitcase)":{ru:"Тяга «чемодан»"},
    "Soulevé de Terre avec Déficit":{ru:"Становая тяга с дефицита"},
    "Split Squat TRX (Sangles)":{ru:"Выпады в TRX"},
    "Split Squat Élastique (Fente Statique)":{ru:"Статичные выпады с резинкой"},
    "Squat Avant":{ru:"Фронтальные приседания"},
    "Squat Bande Élastique":{ru:"Приседания с резинкой"},
    "Squat Barre avec Bandes Élastiques":{ru:"Приседания со штангой и резинками"},
    "Squat Bulgare":{ru:"Болгарские выпады"},
    "Squat Bulgare Élastique":{ru:"Болгарские выпады с резинкой"},
    "Squat Gobelet (Goblet Squat)":{ru:"Гоблет-приседания"},
    "Squat Hack (Hack Squat)":{ru:"Гакк-приседания"},
    "Squat Kettlebell":{ru:"Приседания с гирей"},
    "Squat Pistol":{ru:"Приседания «пистолетик»"},
    "Squat Pistol TRX (Sangles)":{ru:"Приседания «пистолетик» в TRX"},
    "Squat Poids du Corps (Air Squat)":{ru:"Приседания без веса"},
    "Squat Sauté (Jump Squat)":{ru:"Приседания с выпрыгиванием"},
    "Squat Sumo":{ru:"Приседания сумо"},
    "Squat TRX (Sangles)":{ru:"Приседания в TRX"},
    "Squat avec Rotation du Tronc":{ru:"Приседания с поворотом корпуса"},
    "Squat à la Barre":{ru:"Приседания со штангой"},
    "Superman":{ru:"Упражнение «супермен»"},
    "Suspension Passive (Dead Hang)":{ru:"Вис на перекладине"},
    "Svend Press (Serrage de Plaque)":{ru:"Жим Свенда (сжимание блина)"},
    "Tate Press":{ru:"Жим Тейта"},
    "Thruster":{ru:"Трастер"},
    "Thruster Kettlebell":{ru:"Трастер с гирей"},
    "Thrusters Haltères":{ru:"Трастеры с гантелями"},
    "Tirage Cable Fessiers (Cable Pull Through)":{ru:"Протяжка между ног на блоке"},
    "Tirage Incliné Poulie Haute":{ru:"Тяга верхнего блока в наклоне"},
    "Tirage Iso-Latéral Hammer Strength":{ru:"Изолатеральная тяга Hammer Strength"},
    "Tirage Menton":{ru:"Тяга штанги к подбородку"},
    "Tirage Menton Kettlebell":{ru:"Тяга гири к подбородку"},
    "Tirage Menton Élastique":{ru:"Тяга резинки к подбородку"},
    "Tirage Nuque":{ru:"Тяга верхнего блока за голову"},
    "Tirage Poulie Basse Prise Large":{ru:"Тяга нижнего блока широким хватом"},
    "Tirage Poulie Basse Prise Serrée":{ru:"Тяга нижнего блока узким хватом"},
    "Tirage Poulie Haute (Lat Pulldown)":{ru:"Тяга верхнего блока к груди"},
    "Tirage Poulie Haute Prise Inversée":{ru:"Тяга верхнего блока обратным хватом"},
    "Tirage Poulie Haute Prise Serrée":{ru:"Тяга верхнего блока узким хватом"},
    "Tirage Vertical Alterné Élastique":{ru:"Попеременная тяга резинки сверху"},
    "Tirage Visage (Face Pull)":{ru:"Тяга к лицу (фейс-пул)"},
    "Tirage en Rack (Rack Pull)":{ru:"Тяга из стоек (рэк-пул)"},
    "Traction Assistée":{ru:"Подтягивания в гравитроне"},
    "Traction Assistée avec Banc":{ru:"Подтягивания с опорой на скамью"},
    "Traction Australienne (Poids du Corps)":{ru:"Австралийские подтягивания"},
    "Traction Australienne TRX (Sangles)":{ru:"Австралийские подтягивания в TRX"},
    "Traction Derrière la Nuque":{ru:"Подтягивания за голову"},
    "Traction Lestée":{ru:"Подтягивания с отягощением"},
    "Traction Prise Neutre":{ru:"Подтягивания нейтральным хватом"},
    "Traction Supination (Chin-up)":{ru:"Подтягивания обратным хватом"},
    "Tractions (Pull-up)":{ru:"Подтягивания"},
    "Tractions aux Anneaux":{ru:"Подтягивания на кольцах"},
    "Triceps Corde Poulie":{ru:"Разгибание рук на верхнем блоке с канатом"},
    "Triceps Machine":{ru:"Разгибание рук на трицепс в тренажере"},
    "Triceps Poulie":{ru:"Разгибание рук на верхнем блоке"},
    "Triceps Poulie Basse":{ru:"Разгибание рук на нижнем блоке"},
    "Waiter Curl":{ru:"Подъём гантели «официант»"},
    "Wall Ball":{ru:"Броски мяча в стену"},
    "Y Raise / W Raise":{ru:"Подъёмы Y / W"},
    "Zercher Deadlift":{ru:"Становая тяга Зерхера"},
    "Écarté Arrière Élastique":{ru:"Разведение рук назад с резинкой"},
    "Écarté Décliné Haltères":{ru:"Разведение гантелей головой вниз"},
    "Écarté Haltères":{ru:"Разведение гантелей лёжа"},
    "Écarté Hyght (Hyght Fly)":{ru:"Разведение гантелей Хайта"},
    "Écarté Incliné Haltères":{ru:"Разведение гантелей на наклонной скамье"},
    "Écarté Poulie":{ru:"Сведение рук в кроссовере"},
    "Écarté Poulie Haute à Genoux":{ru:"Сведение рук в кроссовере стоя на коленях"},
    "Écarté TRX (Sangles)":{ru:"Разведение рук в TRX"},
    "Écarté Élastique":{ru:"Разведение рук с резинкой"},
    "Élévation Frontale Allongée Barre":{ru:"Подъём штанги перед собой лёжа"},
    "Élévation Frontale Banc Incliné":{ru:"Подъём перед собой на наклонной скамье"},
    "Élévation Latérale Inclinée Haltère":{ru:"Подъём гантели в сторону в наклоне"},
    "Élévation Latérale Landmine":{ru:"Подъём в сторону с грифом в упоре"},
    "Élévation Latérale Poulie Inclinée":{ru:"Подъём руки в сторону на блоке в наклоне"},
    "Élévations Frontales":{ru:"Подъём гантелей перед собой"},
    "Élévations Frontales Câble":{ru:"Подъём руки перед собой на блоке"},
    "Élévations Frontales Machine":{ru:"Подъём рук перед собой в тренажере"},
    "Élévations Latérales (Lateral Raise)":{ru:"Разведение гантелей в стороны"},
    "Élévations Latérales Câble":{ru:"Подъём рук в сторону на блоке"},
    "Élévations Latérales Kettlebell":{ru:"Разведение гирь в стороны"},
    "Élévations Latérales Machine":{ru:"Разведение рук в стороны в тренажере"},
    "Élévations Latérales Unilatérale Poulie":{ru:"Подъём одной руки в сторону на блоке"},
    "Élévations Mollets Assis":{ru:"Подъёмы на носки сидя"},
    "Élévations Mollets Debout":{ru:"Подъёмы на носки стоя"},
    "Élévations Mollets Penché (Donkey Calf Raise)":{ru:"Подъёмы на носки в наклоне (ослик)"},
    "Élévations Mollets Unilatéral":{ru:"Подъёмы на носки на одной ноге"},
  };
