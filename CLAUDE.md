...
> **Version actuelle : `ft-v1122`** (prochaine : `ft-v1123`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1122 — 🧠 LE TEST A/B MÉMOIRE REÇOIT SA PORTE D'ENTRÉE : UN OUTIL SANS BOUTON N'EST PAS UN OUTIL EN ATTENTE, C'EST UN OUTIL QUI N'EXISTE PAS** — Michel, à la lecture du bilan : *« le test A/B je peux pas le faire »*, puis *« je ne sais pas comment faire »*.
