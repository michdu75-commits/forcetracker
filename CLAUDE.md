...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v686`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v686`** (prochaine : `ft-v687`). Historique complet (ft-v128→574 + gouvernance
