...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v687`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v687`** (prochaine : `ft-v688`). Historique complet (ft-v128→574 + gouvernance
