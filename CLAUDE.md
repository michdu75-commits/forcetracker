...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v710`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v710`** (prochaine : `ft-v711`). Historique complet (ft-v128→574 + gouvernance
