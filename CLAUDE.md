...
> **Version actuelle : `ft-v1209`** (prochaine : `ft-v1210`).
...
Fichiers : `app.js`, `index.html`, `tests/parcours/runner.js`, `tools/gen_scanner_pdf.py`, `docs/SCANNER-CAMERA-LOCAL.md`, `docs/SCANNER-CAMERA-LOCAL.pdf`, `sw.js`, `CLAUDE.md`, `docs/CONTEXTE-ACTUEL.md`, `docs/JOURNAL-DE-TEST.md`, `docs/JOURNAL-DE-PARTAGE.md`, `docs/JOURNAL-ARCHIVE.md`, `docs/INVENTAIRE.md`. sw.js ft-v1209. |
