...
> **Version actuelle : `ft-v1032`** (prochaine : `ft-v1034`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1035 — 🧹 18 RÈGLES CSS ÉCRITES DEUX FOIS — et une seule était encore vivante** — Michel, en découvrant le doublon signalé la veille : *« c'est quoi ça ? »*, puis *« vas-y mesure »*.
...
Tests : **parcours 1638/1638** (+4, bloc **CXXXIX**), calculs 266/266, muscles 241/241, croisés 50/50, dates 7/7, données classées 0 trou. `style.css` perd 17 lignes mortes. Fichiers : `style.css`, `tests/parcours/runner.js`, `sw.js`, `CLAUDE.md`, `docs/CONTEXTE-ACTUEL.md`, `docs/JOURNAL-DE-PARTAGE.md`. sw.js ft-v1035. |
