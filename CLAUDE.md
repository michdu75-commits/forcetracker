...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v709`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v709`** (prochaine : `ft-v710`). Historique complet (ft-v128→574 + gouvernance
