...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v714`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v714`** (prochaine : `ft-v715`). Historique complet (ft-v128→574 + gouvernance
