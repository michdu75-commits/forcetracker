...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v715`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v715`** (prochaine : `ft-v716`). Historique complet (ft-v128→574 + gouvernance
