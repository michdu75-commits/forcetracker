...
> **Version actuelle : `ft-v1129`** (prochaine : `ft-v1130`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1129 — 🔗 LE SUPERSET DE MILO N'ATTEIGNAIT JAMAIS LA SÉANCE — ET IL ÉTAIT ANNONCÉ AUX UTILISATEURS DEPUIS LE 12/08** — Michel : *« maintenant le seanceJson que l'autre claude m'a laissé »*.
