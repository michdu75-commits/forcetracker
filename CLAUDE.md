...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v717`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v717`** (prochaine : `ft-v718`). Historique complet (ft-v128→574 + gouvernance
