...
| ft-v274 | **Boîte à idées : destination email** = `forcetracker.app@gmail.com` (compte dédié de l'app, séparé du mail perso de Michel) au lieu de `michdu75@gmail.com` — `TESTER_FEEDBACK_EMAIL` dans constants.js. ← **actuel** |
