...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v658`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v658`** (prochaine : `ft-v659`). Historique complet (ft-v128→574 + gouvernance
