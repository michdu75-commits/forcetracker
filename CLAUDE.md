...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v694`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v694`** (prochaine : `ft-v695`). Historique complet (ft-v128→574 + gouvernance
