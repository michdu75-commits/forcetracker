...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v697`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v697`** (prochaine : `ft-v698`). Historique complet (ft-v128→574 + gouvernance
