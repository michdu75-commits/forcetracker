...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v708`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v708`** (prochaine : `ft-v709`). Historique complet (ft-v128→574 + gouvernance
