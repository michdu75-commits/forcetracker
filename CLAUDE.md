...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v696`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v696`** (prochaine : `ft-v697`). Historique complet (ft-v128→574 + gouvernance
