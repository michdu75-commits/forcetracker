...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v656`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v656`** (prochaine : `ft-v657`). Historique complet (ft-v128→574 + gouvernance
