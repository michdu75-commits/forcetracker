...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v691`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v691`** (prochaine : `ft-v692`). Historique complet (ft-v128→574 + gouvernance
