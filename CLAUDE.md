...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v704`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v704`** (prochaine : `ft-v705`). Historique complet (ft-v128→574 + gouvernance
