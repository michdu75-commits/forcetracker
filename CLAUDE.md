...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v693`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v693`** (prochaine : `ft-v694`). Historique complet (ft-v128→574 + gouvernance
