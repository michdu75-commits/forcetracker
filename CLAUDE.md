...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v711`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v711`** (prochaine : `ft-v712`). Historique complet (ft-v128→574 + gouvernance
