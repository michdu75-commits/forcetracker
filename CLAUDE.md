...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v698`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v698`** (prochaine : `ft-v699`). Historique complet (ft-v128→574 + gouvernance
