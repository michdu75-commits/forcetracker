...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v701`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v701`** (prochaine : `ft-v702`). Historique complet (ft-v128→574 + gouvernance
