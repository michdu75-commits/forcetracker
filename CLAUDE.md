...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v699`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v699`** (prochaine : `ft-v700`). Historique complet (ft-v128→574 + gouvernance
