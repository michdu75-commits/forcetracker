...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v713`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v713`** (prochaine : `ft-v714`). Historique complet (ft-v128→574 + gouvernance
