...
> **Version actuelle : `ft-v1033`** (prochaine : `ft-v1034`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1033 — 📍 UNE CHARGE PRESCRITE SANS REPÈRE LE DIT** — application directe du critère donné par Michel le jour même : *« la coach savait que moi je m'y connais. Tout le monde ne connaît pas ce que représente le "lourd". »*
