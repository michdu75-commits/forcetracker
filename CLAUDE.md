...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v712`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v712`** (prochaine : `ft-v713`). Historique complet (ft-v128→574 + gouvernance
