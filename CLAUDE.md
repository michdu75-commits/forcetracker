...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v662`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v662`** (prochaine : `ft-v663`). Historique complet (ft-v128→574 + gouvernance
