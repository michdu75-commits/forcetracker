...
| ft-v267 | **Accessoires : wrist-wraps + magnésie reçus** (2ᵉ .rar de Michel) : `wrist-wraps.jpg` (ZEUZ) + magnésie en **2 photos** (`magnesie-bloc.jpg` + `magnesie-liquide.jpg`, carte magnésie passée à 2 emplacements bloc/liquide). Précachés. ⏳ **Ne manque plus que le maillot ×3** (`maillot-couche/squat/souleve.jpg`). ← **actuel** |
