...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v660`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v660`** (prochaine : `ft-v661`). Historique complet (ft-v128→574 + gouvernance
