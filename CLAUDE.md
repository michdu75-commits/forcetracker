...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v702`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v702`** (prochaine : `ft-v703`). Historique complet (ft-v128→574 + gouvernance
