...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v705`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v705`** (prochaine : `ft-v706`). Historique complet (ft-v128→574 + gouvernance
