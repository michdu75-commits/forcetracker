...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v719`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v719`** (prochaine : `ft-v720`). Historique complet (ft-v128→574 + gouvernance
