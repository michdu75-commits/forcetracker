...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v659`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v659`** (prochaine : `ft-v660`). Historique complet (ft-v128→574 + gouvernance
