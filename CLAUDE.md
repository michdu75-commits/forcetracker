...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v703`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v703`** (prochaine : `ft-v704`). Historique complet (ft-v128→574 + gouvernance
