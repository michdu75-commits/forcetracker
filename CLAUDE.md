...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v685`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v685`** (prochaine : `ft-v686`). Historique complet (ft-v128→574 + gouvernance
