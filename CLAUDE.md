...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v718`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v718`** (prochaine : `ft-v719`). Historique complet (ft-v128→574 + gouvernance
