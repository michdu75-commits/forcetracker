...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v692`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v692`** (prochaine : `ft-v693`). Historique complet (ft-v128→574 + gouvernance
