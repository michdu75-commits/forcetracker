...
> **Version actuelle : `ft-v1168`** (prochaine : `ft-v1169`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1168 — 🔇 LES RECHERCHES QUI NE RENDENT RIEN — LE 2ᵉ POINT DE MESURE DU DÉTECTEUR** — Michel, dans la foulée de ft-v1167 : ***« prends aussi les recherches qui ne rendent rien »***.
