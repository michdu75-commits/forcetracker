...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v657`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v657`** (prochaine : `ft-v658`). Historique complet (ft-v128→574 + gouvernance
