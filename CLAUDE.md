...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v707`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v707`** (prochaine : `ft-v708`). Historique complet (ft-v128→574 + gouvernance
