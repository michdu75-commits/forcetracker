...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v688`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v688`** (prochaine : `ft-v689`). Historique complet (ft-v128→574 + gouvernance
