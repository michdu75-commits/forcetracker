...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v706`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v706`** (prochaine : `ft-v707`). Historique complet (ft-v128→574 + gouvernance
