...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v654`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v654`** (prochaine : `ft-v655`). Historique complet (ft-v128→574 + gouvernance
