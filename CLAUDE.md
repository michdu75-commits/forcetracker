...
- 🧨 **`docs/GALERES-ET-LECONS.md`** — la **mémoire des pièges** : grosses galères résolues (son iOS, 4G, perte de données, backend qui tombe…), problèmes **encore ouverts**, ce qui **manque**, et les **réflexes** pour ne pas re-tomber dedans. À consulter avant un chantier risqué, et à **compléter à chaque nouvelle galère**.
