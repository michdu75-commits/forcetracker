...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v655`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v655`** (prochaine : `ft-v656`). Historique complet (ft-v128→574 + gouvernance
