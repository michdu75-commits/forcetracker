...
> **Version actuelle : `ft-v1147`** (prochaine : `ft-v1148`). Historique complet (ft-v128→574 + gouvernance
...
**ft-v1147 — 🔗 LES NOMS D'EXERCICES SE DÉDOUBLENT DEPUIS LE 24/08 — ET MICHEL A CRU À UNE PERTE DE DONNÉES** — en pleine séance, à la salle : *« Perte de données. Dans précédent j'ai déjà fait cet exercice et l'historique a disparu et je n'ai plus de stats non plus »*.
