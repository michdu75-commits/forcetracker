...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v690`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v690`** (prochaine : `ft-v691`). Historique complet (ft-v128→574 + gouvernance
