...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v661`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v661`** (prochaine : `ft-v662`). Historique complet (ft-v128→574 + gouvernance
