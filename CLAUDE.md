...
**⏭️ CE QUE ÇA NE FAIT PAS** : ⛔ **le cardio SEUL n'ouvre toujours pas d'écran de fin et n'enregistre aucune séance** — mesuré et signalé à Michel, qui répond *« il va falloir creuser pour le cardio »*. **Pas encore traité** : il peut y avoir une décision derrière, je cherche avant de « réparer » (**R30**).
