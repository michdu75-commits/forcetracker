...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v695`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v695`** (prochaine : `ft-v696`). Historique complet (ft-v128→574 + gouvernance
