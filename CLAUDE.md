...
| `sw.js` | Service Worker (cache-first HTML navigation, cache-first assets) — cache versionné `ft-vNN`, bumpé à chaque release (**actuel : `ft-v700`** — voir le journal des versions) |
...
> **Version actuelle : `ft-v700`** (prochaine : `ft-v701`). Historique complet (ft-v128→574 + gouvernance
