...
const _HELP_DATA={
  home:{
    ...
    tips:[
      ...
      /* ⭐ ÉTENDU plutôt que doublé (R2) : c'est le même sujet — d'où vient le score de récup.
         ⛔ Et l'aide DIT le sens du changement, parce qu'il est contre-intuitif : la personne
         s'attend à ce qu'une correction « plus juste » la punisse, et c'est l'inverse. */
      {i:'🔥',t:'<b>Ta fatigue s\'additionne</b> (depuis le 04/09/2026). Deux séances dans les <b>48 h</b> coûtent maintenant <b>plus</b> qu\'une seule — avant, <b>seule la dernière</b> comptait : que tu en aies fait 1, 2 ou 3, le score voyait exactement la même chose. Chacune s\'efface sur ses propres 48 h, et la somme ne peut jamais dépasser ce que coûte <b>une séance maximale</b>. ⭐ Le facteur <b>« 🔥 Jours enchaînés »</b> a donc disparu de « Pourquoi ce score ? » : c\'était un forfait à la louche (−4 ou −8 selon le nombre de jours), remplacé par la vraie mesure — le garder ferait <b>compter deux fois</b>. ⚠️ <b>Et le sens du changement surprend</b> : sur 60 jours réels, <b>25 journées REMONTENT</b> et 3 seulement baissent, parce que le forfait mordait souvent alors que la fatigue réelle avait déjà fondu. Le plus gros écart mesuré est de <b>6 points</b>.'},
      ...
      {i:'💡',t:'Ton score de récup (sur NN/100) estime à quel point ton corps est prêt à s\'entraîner aujourd\'hui. Tape « Pourquoi ce score ? » juste en dessous pour voir, en clair, D\'OÙ il vient : sommeil, séance récente, âge, forme du jour… chaque facteur avec sa raison et son +/−. Il remonte au fil de la journée après une séance, et reste un simple repère — ton ressenti prime toujours.'},
  ...
  nutrition:{
    ...
    tips:[
      ...
      /* 📌 POINT 3 DE LA RÈGLE #11 — L'AIDE SEULE, ni pop-up ni point rouge, et c'est argumenté.
         Ce qui change se VOIT tout seul (une bande qui suit le doigt) et ne demande rien à
         personne : une pop-up dirait « les puces de repas restent maintenant à l'écran », soit
         du bruit pour expliquer une chose qu'on comprend en la regardant (R19/R25). ⛔ Et un
         point rouge enverrait chercher sur l'onglet, alors que ça ne se voit que DANS la modale
         d'ajout. ⚠️ Ce que l'aide porte, en revanche, c'est ce qu'on ne devine pas : que le
      ...
      {i:'\ud83e\udd57',t:'<b>Des centaines de mots de tous les jours trouvent enfin leur aliment.</b> <b>tortiglioni</b>, <b>fettuccine</b>, <b>pappardelle</b>, <b>riz jasmin</b>, <b>riz arborio</b>, <b>sticky rice</b> ne rendaient <b>rien</b> — l\'aliment était pourtant dans ton téléphone. ⭐ <b>Aucune valeur n\'a été inventée</b> : ces mots ouvrent une porte vers un aliment qui existait déjà dans la table officielle française, avec ses chiffres à lui. ⚠️⚠️ <b>ET UN CHIFFRE A CHANGÉ, il faut le savoir</b> : quand tu tapes <b>riz</b> ou <b>pâtes</b>, c\'est maintenant la version <b>CUITE</b> qui arrive en premier (riz 155 kcal/100 g, pâtes 167) et non la version crue (350 et 364). C\'est ce qu\'on mange, donc c\'est ce qu\'on note le plus souvent. ⛔ <b>Mais la version crue n\'a pas disparu</b> : elle est <b>juste en dessous</b> dans la liste. Si tu pèses tes pâtes sèches avant cuisson, prends-la — elle est à un doigt. 👉 <b>Le repère qui ne trompe pas</b> : le nom le dit toujours (« cuit », « cru », « sans sel ajouté »). Lis-le avant de valider, l\'écart est du simple au double. ⛔ Et si un mot ne rend toujours rien, c\'est qu\'il n\'est pas dans la table nationale — <b>whey</b>, <b>créatine</b>, <b>naan</b>, <b>sirop d\'agave</b> n\'y sont pas. On préfère te le dire que te servir autre chose à la place. ⭐⭐ <b>ET LA RECHERCHE ACCEPTE MIEUX TA FAÇON D\'ÉCRIRE</b> : une <b>virgule</b> ne la fait plus échouer (« Boulgour, cuit » ne rendait rien), et les petits mots comme <b>de</b>, <b>du</b>, <b>au</b> ne bloquent plus — <b>filet de bœuf</b>, <b>joue de bœuf</b>, <b>foie de veau</b>, <b>jarret de veau</b>, <b>graine de lin</b> trouvent enfin leur aliment. ⛔ <b>Mais « sans » et « avec » comptent toujours</b>, et c\'est voulu : sinon « coca sans sucre » deviendrait « coca sucre », l\'exact contraire. 👉 <b>Ce qui ne marche toujours pas, et pourquoi</b> : les mots de <b>conditionnement</b>. « copeaux de parmesan » ne rend rien parce que « copeaux » n\'existe dans aucun libellé — tape simplement <b>parmesan</b>. La table nomme l\'aliment, pas la façon dont il est découpé. ⚠️⚠️ <b>ET LE PIÈGE DES NOMS PRESQUE IDENTIQUES</b> — le cas est réel : la table écrit « Cola, <b>sucré</b>, avec édulcorants » (<b>24 kcal/100 g</b>) <b>et</b> « Cola, <b>sans sucres ajoutés</b>, avec édulcorants » (<b>1 kcal/100 g</b>). Deux lignes qui se ressemblent, <b>24 fois</b> d\'écart. ⭐ Taper <b>coca zéro</b>, <b>coca light</b> ou <b>pepsi max</b> te met maintenant la bonne en tête — mais le réflexe reste le même partout : <b>lis le libellé en entier avant de valider</b>. C\'est lui qui dit « sucré » ou « sans sucres ajoutés », « cru » ou « cuit ». ⛔⛔ <b>Et le Coca n\'était qu\'un cas sur NEUF</b> : la table porte <b>9 paires</b> de ce type (limonade, tonic, ice tea, sodas, boisson énergisante…), et la version <b>sucrée</b> gagnait à chaque fois. Elles sont toutes corrigées. ⭐ <b>Et beaucoup de boissons qui ne rendaient rien en rendent une</b> : <b>ice tea</b>, <b>red bull</b>, <b>orangina</b>, <b>schweppes</b>, <b>latte</b>, <b>bière blonde</b>, <b>lait d\'amande</b>, <b>lait de soja</b>, <b>lait d\'avoine</b>. ⚠️⚠️ <b>Le pire de tous était le lait d\'amande</b> : il rendait un <b>chocolat au lait aux fruits secs à 559 kcal/100 g</b>, pour une boisson qui en fait <b>36</b>. ⛔ <b>Mais le « lait de coco » n\'a PAS bougé, exprès</b> : la table distingue le <b>lait de coco de cuisine</b> (199 kcal) de la <b>boisson à la noix de coco</b> (30). Ce sont deux produits différents — les confondre serait refaire l\'erreur qu\'on vient de corriger. ⛔ Et ce qui n\'existe pas dans la table nationale ne rend toujours rien, exprès : <b>powerade</b>, <b>gatorade</b>, <b>mojito</b>, <b>whey</b>. Pour ceux-là, le code-barres ou « ⚖️ Saisir les valeurs pour 100 g ».'},
      /* 🍔 POINT 3 DE LA RÈGLE #11 (ft-v1114) — L'AIDE PORTE CE QU'ON NE DEVINE PAS : d'où
         ...
         d'où il vient serait pire qu'absent (R32/R33). */
      {i:'\ud83c\udf54',t:'<b>Le fast-food par son nom.</b> Tape <b>big mac</b>, <b>whopper</b>, <b>tenders kfc</b>, <b>frites mcdo</b> : le produit sort avec son <b>enseigne</b> et le <b>poids de sa portion</b> déjà rempli (232 g pour un Big Mac) — tu n\'as plus qu\'à valider, ou à mettre ton poids si tu n\'as pas tout mangé. ⭐ <b>D\'où viennent ces chiffres</b> : des <b>sources officielles des enseignes</b>, relevées dans un tableau puis vérifiées ligne à ligne. Ce ne sont <b>pas</b> des valeurs mesurées par l\'app, et chaque proposition affiche son enseigne pour que tu le saches. ⚠️⚠️ <b>Et certaines lignes portent un ⚠️ : c\'est voulu.</b> Quand un chiffre publié ne tient pas debout — des calories annoncées qui ne collent pas aux macros de la même fiche, des morceaux dont le prix en calories change du simple au double — l\'app <b>te le dit et te montre le chiffre qui permet de juger</b>, au lieu de faire disparaître la ligne. 👉 <b>Pourquoi on ne les cache pas</b> : une ligne absente te pousse vers l\'<b>estimation automatique</b>, qui est bien moins fiable qu\'une valeur publiée douteuse. Mieux vaut un chiffre discutable que tu peux juger qu\'une estimation que tu crois. ⭐⭐ <b>Et la base est passée de 27 à 128 produits</b> : <b>Quick</b> y entre avec sa table officielle complète (burgers, wraps, salades, accompagnements), <b>Domino\'s</b> s\'étoffe. ⛔ <b>Les valeurs d\'avant n\'ont pas bougé d\'un chiffre</b> — c\'est la même source, étendue. ⚠️ <b>Ce qui n\'y est pas, et pourquoi</b> : les sandwichs <b>Subway</b> — leur document officiel donne les calories mais pas les protéines, glucides et lipides, et une ligne sans macros ne peut pas alimenter ton journal. ⚠️ Et <b>O\'Tacos n\'y est pas</b> : leur table ne publie que des desserts, aucun tacos — la garder aurait fait qu\'en tapant « tacos » tu obtiennes une <b>glace</b>. Un mot qui ne désigne pas ce qu\'on croit est pire qu\'un mot qui ne rend rien. ⛔ Et si un produit manque, le plus sûr reste le <b>code-barres</b> ou la <b>photo de l\'étiquette</b>.'},
      /* 🍔 ⚠️ L'ENTRÉE CI-DESSOUS A ÉTÉ CORRIGÉE EN ft-v1114 — elle promettait « les noms sont
         GÉNÉRIQUES, jamais des marques » et « tu ne verras pas Big Mac ». Depuis qu'une base
         d'enseignes existe, c'était devenu FAUX. *Une aide qui nomme un repère inexistant est
         pire qu'une aide absente, parce qu'on la croit* (famille §31 de `BUGS.md`, R23). */
      {i:'\ud83c\udf54',t:'<b>Cherche avec les mots que tu emploies, pas ceux de la table.</b> Tape <b>mcdo</b>, <b>macdo</b> ou <b>fast food</b> : tu obtiens un menu — un sandwich, des frites, des nuggets. <b>coca</b> trouve le cola, <b>coca zéro</b> et <b>coca light</b> les versions aux édulcorants, <b>soda</b> les boissons gazeuses. ⭐ Avant, ces mots-là ne rendaient <b>rien</b>, alors que les aliments étaient déjà dans ton téléphone — et ça ne se voyait qu\'<b>hors ligne</b>, parce qu\'avec du réseau la recherche en ligne rattrapait le coup. ⚠️ <b>Deux familles de résultats, et elles ne disent pas la même chose</b> : la section <b>🍔 FAST-FOOD</b> donne le produit précis d\'une enseigne (« Big Mac · McDonald\'s ») ; la section <b>🥗 ALIMENTS</b> donne le <b>générique</b> de la table officielle française (« Hamburger, <i>de restauration rapide</i> ») — celui-là sert quand ton burger n\'est d\'aucune enseigne connue. 👉 Dans ce cas : prends le générique et <b>mets son poids</b> (un gros burger fait ~220 g), ou utilise « ⚖️ Saisir les valeurs pour 100 g » avec l\'affichage du restaurant. ⛔ Et <b>tacos</b> ne rend rien : il n\'est pas dans la table, et on préfère te le dire plutôt que te servir un kebab à sa place.'},
      {i:'⚖️',t:'<b>Un produit dont les valeurs sont fausses, tu peux le corriger une bonne fois.</b> Dans « Ajouter un aliment », le bouton <b>« ⚖️ Saisir les valeurs pour 100 g »</b> te laisse recopier le tableau de ton étiquette. Ensuite tu tapes seulement <b>ta dose</b>, et l\'app calcule — cette fois-ci <b>et toutes les suivantes</b>. ⭐ C\'est ce qui manquait : jusque-là ce chiffre ne pouvait venir que d\'un code-barres ou de la base d\'aliments, donc <b>un produit dont la fiche est incomplète restait faux à vie</b>, et sa vieille ligne revenait à chaque fois. ⛔ <b>C\'est la colonne « pour 100 g »</b>, pas celle « par portion » : si tu te trompes de colonne, l\'app te le dit (plus de 100 g de matière dans 100 g de produit, c\'est impossible). ⚠️ Et ces valeurs sont enregistrées comme venant de <b>ton étiquette</b>, pas d\'une base de données — l\'app ne fait jamais passer ce que tu as tapé pour une source vérifiée.'},
      /* 📷 ft-v1163 — LA SUITE DIRECTE DU VOISIN : il explique le calibrage, celle-ci dit
         QUAND l'app te l'ouvre toute seule, et surtout ce qu'on y gagne. */
      {i:'\ud83d\udcf7',t:'<b>Quand un code-barres trouve le produit mais pas ses valeurs, l\'app t\'ouvre maintenant la saisie pour 100 g.</b> \u26a0\ufe0f <b>C\'est fr\u00e9quent</b> : beaucoup de fiches de produits de marque n\'ont que le nom et la marque, sans tableau nutritionnel. Avant, tu avais juste un message \u00ab saisis \u00e0 la main \u00bb et un formulaire vide \u2014 <b>et surtout aucun moyen d\'indiquer une quantit\u00e9</b>, donc la ligne restait impossible \u00e0 recalculer, ce jour-l\u00e0 et tous les suivants. \u2b50 <b>Maintenant</b> : le <b>nom du produit est rempli</b> (l\'app le connaissait, elle le jetait), et le bloc <b>\u00ab \u2696\ufe0f Saisir les valeurs pour 100 g \u00bb s\'ouvre tout seul</b>. \ud83d\udc49 <b>Recopie le tableau de l\'\u00e9tiquette UNE fois</b> : ensuite tu tapes seulement <b>ta quantit\u00e9 en grammes</b>, et l\'app calcule \u2014 cette fois-ci <b>et toutes les suivantes</b>, parce que le pour-100 g est enregistr\u00e9 avec l\'aliment. \u2b50 <b>Pareil pour la photo d\'\u00e9tiquette</b> quand les valeurs ne sont pas lues : m\u00eame porte, m\u00eame message \u2014 et l\u00e0 tu as d\u00e9j\u00e0 l\'\u00e9tiquette sous les yeux. \u26d4 <b>L\'app n\'invente jamais rien</b> : elle ne devine ni un poids ni des valeurs, elle t\'ouvre le champ o\u00f9 <b>toi</b> tu sais lire. \u26a0\ufe0f Et si tu renonces, rien n\'est retenu \u2014 le bloc se vide \u00e0 l\'aliment suivant, pour qu\'une \u00e9tiquette ne se retrouve jamais coll\u00e9e sur un autre produit.'},
      /* 📦 ft-v1174 — AIDE OUI, POINT ROUGE NON, POP-UP NON, et c'est la décision de ft-v1165
         rejouée : la pastille n'apparaît QUE sur un scan dont la fiche porte un poids lisible.
         Un point rouge enverrait donc chercher quelque chose d'invisible tant qu'on n'a pas
         scanné le bon produit. ⭐ Et l'aide doit dire ce que la pastille N'EST PAS — le poids du
         PAQUET, pas celui de l'assiette — parce que c'est ça qui évite de la taper les yeux
         fermés sur un pot de 1 kg (R25 : la pop-up annonce, l'aide explique). */
      {i:'\ud83d\udce6',t:'<b>Quand tu scannes, l\'app te propose maintenant le poids du paquet.</b> Une pastille appara\u00eet sous le champ des grammes : <b>\ud83d\udce6 250 g (le paquet entier)</b>. Un appui, et tes 4 valeurs se calent dessus. \u2b50 <b>Ce poids \u00e9tait d\u00e9j\u00e0 l\u00e0 depuis toujours</b> : l\'app le demandait \u00e0 la base de produits \u00e0 chaque scan\u2026 et le jetait sans le lire. \u26d4\u26d4 <b>Mais le champ n\'est PAS rempli tout seul, et c\'est voulu</b> : c\'est le poids <b>du paquet</b>, pas de ce que tu as mang\u00e9. Une bo\u00eete de ratatouille que tu vides dans l\'assiette \u2192 c\'est le bon chiffre. Un pot de prot\u00e9ine de <b>1 kg</b> \u2192 tu n\'en manges pas 1 kg. \ud83d\udc49 <b>Regarde avant de taper</b> : l\'app propose, elle ne d\u00e9cide pas. \u2b50 <b>\u00c7a marche aussi quand la fiche n\'a aucune valeur</b> : tu recopies l\'\u00e9tiquette pour 100 g, et le poids du paquet t\'attend juste apr\u00e8s \u2014 c\'est le cas le plus fr\u00e9quent sur les produits de marque. \u26a0\ufe0f <b>Ce qui ne propose rien, et pourquoi</b> : les <b>volumes</b> (\u00ab 1 L \u00bb) \u2014 un litre d\'eau p\u00e8se 1 kg, un litre d\'huile 920 g, un litre de miel 1,4 kg : l\'app ne conna\u00eet pas la densit\u00e9 et pr\u00e9f\u00e8re se taire plut\u00f4t que t\'annoncer un poids cr\u00e9dible et faux. Les <b>lots</b> (\u00ab 6 x 125 g \u00bb) \u2014 750 g de paquet ou 125 g d\'unit\u00e9 ? C\'est l\'unit\u00e9 que tu manges, mais l\'app ne peut pas le deviner. Et <b>au-del\u00e0 de 5 kg</b>, ce n\'est plus une portion mais un sac.'},
      {i:'📌',t:'<b>Le repas choisi reste sous tes yeux pendant que tu descends.</b> Avant, les puces <i>Petit-déj · Collation · Déjeuner · Collation 2 · Dîner</i> disparaissaient dès qu\'on faisait défiler — or tout ce qui sert à saisir l\'aliment est plus bas. ⭐ <b>Mesuré</b> : elles sortaient de l\'écran au bout de <b>236 px</b>, sur une fenêtre qui en défile <b>951</b>. Autrement dit, au moment de valider, tu ne voyais <b>jamais</b> où l\'aliment allait tomber. 👉 Elles restent maintenant en haut, et tu peux <b>changer de repas depuis le bas</b>. ⚠️ <b>Et c\'est utile parce que le repas est DEVINÉ</b> : l\'app le pré-règle sur l\'heure qu\'il est (avant 11 h → Petit-déj). Si tu notes ton dîner le lendemain matin, c\'est à toi de corriger — l\'app propose, elle ne décide pas. 👉 Le message de confirmation <b>nomme désormais le repas</b> : « Ajouté · Dîner » et non plus « Ajouté au journal ».'},
      ...
      /* ⚡ LE JUMEAU DU VOISIN (ft-v1162) : la même physique, appliquée aux CALORIES au lieu
         de la matière. Il est ici parce que le contrôle des 25 % ne pouvait pas le dire : son
         plancher de 60 kcal éteint le pourcentage sur toute entrée de moins de 240 kcal. */
      {i:'⚡',t:'<b>Et si l\'app te dit que des calories « ne peuvent pas tenir » dans ta portion, c\'est la même physique.</b> Une fois les protéines, glucides et lipides comptés, il ne reste qu\'un peu de matière libre dans l\'aliment — et <b>rien n\'est plus énergique que le gras (9 kcal par gramme)</b>. Donc les calories ont un <b>maximum</b>, et il se calcule. ⭐ <b>Le cas réel</b> : une dose de <b>30 g</b> de poudre marquée <b>26 g de protéines</b>, 1 de glucides, 1 de lipides. Ces macros valent <b>117 kcal</b>, et les <b>2 g</b> qui restent ne peuvent pas en apporter plus de 18 : <b>135 kcal au grand maximum</b>. La ligne en affichait <b>156</b>. ⛔⛔ <b>Et l\'ancien contrôle ne pouvait pas le voir</b> : il ne parle qu\'au-delà de 60 kcal d\'écart, or il n\'y en avait que 39 — <b>un quart de la ligne, tous les jours, sans un mot</b>. ⭐ <b>Pourquoi c\'est plus solide qu\'un pourcentage</b> : ça ne dépend d\'aucun seuil choisi. Vérifié sur les <b>3 235 aliments</b> de la table française et les <b>123 produits</b> de fast-food : <b>aucun</b> ne déclenche l\'alerte — pas même l\'huile pure, le sucre ou le miel. ⚠️ <b>Il faut avoir indiqué un poids en grammes</b> : sans ça, l\'app n\'a rien à quoi comparer et se tait. 👉 Le bouton propose la valeur des macros ; <b>c\'est une proposition</b>, tu peux l\'ignorer et corriger plutôt une macro ou la quantité.'},
  ...
  log:{
    ...
    tips:[
      ...
      {i:'🏃',t:'<b>Deux boutons, un seul enregistre.</b> Dans le bloc Cardio, <b>« ✓ C\'est noté »</b> range ta saisie et replie le bloc — <b>ta séance n\'est pas encore enregistrée</b>. C\'est le <b>gros bouton rouge du bas</b> qui l\'inscrit dans ton historique : il s\'appelle <b>« 🏁 Terminer la séance »</b> si tu as validé des séries, <b>« 🏁 Enregistrer le cardio »</b> si tu n\'as fait que du cardio. ⭐ <b>Un cardio seul est une vraie séance</b> : il a sa durée, ses calories, il apparaît dans ton calendrier et Milo le voit. 💡 Tant qu\'elle n\'est pas enregistrée, l\'Accueil te le rappelle avec <b>« ↩ Reprendre la séance »</b>. 📈 Dans ton historique (onglet Progrès) elle s\'appelle <b>« 🏃 Cardio »</b> et dit ce que c\'était — « Tapis 45 min (Modéré) ».'},
...
function _recoQuandHtml(d){
  ...
  /* ⛔⛔ LA 2ᵉ BRANCHE EST MORTE AVEC LE FORFAIT (option B, 04/09/2026). `projectionRecup` ne
     rend plus jamais `source:'jours'` : ce chemin annonçait *« le temps que ton enchaînement de
     jours se vide »* pour une règle qui n'existe plus. **Gardé, l'écran aurait expliqué au
     lecteur un mécanisme supprimé** — et c'est le 4ᵉ lecteur de cette règle, après le calcul,
     le conseil et la projection. *Une phrase qui décrit un rouage retiré est pire qu'une phrase
     absente : on la croit.* L'heure reste annoncée, elle est connue à la minute. */
  const heure = ' vers '+t.getHours()+' h';
  ...
  return '<div style="margin-top:10px;background:var(--bg2);border:1px solid var(--sep);border-radius:12px;padding:11px 13px;">'
    ...
    +' — c\'est l\'effet de tes séances récentes, il s\'efface en continu.'
    +reste+'</div>'
...
function saveKcalEdit(){
  ...
  /* B2 : le même propriétaire que la relecture. ⛔ Les appels restent sur LEUR ligne : en 20eac697,
