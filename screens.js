...
const _HELP_DATA={
  ...
  log:{
    ...
    tips:[
      ...
      {i:'🖨️',t:'Imprimer / PDF : dans 📋 Mes Programmes, le bouton 🖨️ sur un programme génère une feuille propre (exercices, séries × reps, colonne « Poids » vide à remplir à la salle). Ton téléphone propose de l\'imprimer ou de l\'enregistrer en PDF (iPhone : Partager → Imprimer).'},
