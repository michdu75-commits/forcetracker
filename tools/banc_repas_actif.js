 ...
 *     `tests/parcours/repas_actif.js`. Il n'existe pas de version « du banc » et de
 *     version « des mutations » qui pourraient diverger.
 *
 * Usage : node tools/banc_repas_actif.js
 */
const fs = require('fs');
...
(async () => {
  const M = require(path.join(ROOT, 'tests/parcours/repas_actif.js'));
