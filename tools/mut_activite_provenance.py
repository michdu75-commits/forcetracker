...
MUT = [
    ...
    ('M11', ST, "return (v!==null&&v!==''&&isFinite(n)&&[1.2,1.375,1.55,1.725,1.9].indexOf(n)>=0)?n:null;",
     "return (v!==null&&v!==''&&isFinite(n)&&n>=1&&n<=2)?n:null;", 'rouge', 'DÉGUISÉE : une PLAGE au lieu des 5 niveaux (1.4 passe)'),
