  ...
  try {
    ...
    userContent.push(
      { type:'text', text:
        ...
        + 'DÉTAIL PAR SEGMENT (schéma du corps avec valeurs par zone, gauche=G/L et droite=D/R), en kg : armMuscleL/armMuscleR (muscle bras G/D), trunkMuscle (muscle tronc), legMuscleL/legMuscleR (muscle jambe G/D) ; armFatL/armFatR (graisse bras G/D), trunkFat (graisse tronc), legFatL/legFatR (graisse jambe G/D). Prends le grand chiffre en kg, ignore le pourcentage et les mots Normal/Élevé.\n'
