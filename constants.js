...
const WHATS_NEW=[
  ...
  /* 📊 ELLE SE MÉRITE SUR LE CRITÈRE « UN REPÈRE A BOUGÉ » — et c'est un cas net : deux tuiles
    ...
    {v:74, ic:'📊', t:'« Ce mois » ne garde que deux tuiles', d:'① <b>Volume et Force quittent l\'Accueil</b> : en les tapant, on arrivait sur un écran où <b>ni l\'un ni l\'autre n\'est affiché</b>. ② <b>Ton tonnage n\'est pas perdu</b> — il est juste en dessous, <b>dans le calendrier</b>, semaine par semaine. ③ ⚠️ Le <b>total de tes trois barres</b>, lui, <b>n\'est plus affiché</b> nulle part : il reviendra quand il aura un écran à lui. 💡 Le pourquoi est dans l\'aide ❔ de l\'Accueil.'},
