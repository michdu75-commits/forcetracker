  ...
  guide: {
    ...
    html:(function(){
      ...
      return '<div style="display:flex;flex-direction:column;gap:11px;padding:0 2px 8px;">'
        ...
        +pcard('👕','Maillot / combinaison de force','En force athlétique « équipée » : combinaisons de squat/soulevé et chemises de bench très rigides qui renvoient de la force. C\'est un monde à part (compétitions spécifiques), pas nécessaire pour progresser.',[{src:'accessoires/maillot.jpg'}])
