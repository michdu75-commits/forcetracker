  ...
  help: {
    ...
    html:`<div style="display:flex;flex-direction:column;gap:10px;padding:0 2px 8px;">
      ${[
        ...
        {ic:'📋',t:'Programmes',d:'Sauvegarde ta séance en cours comme programme réutilisable. Charge-le pour retrouver les exercices avec les poids de la dernière fois. Bouton 🤖 pour une analyse IA de ton programme. Bouton ✏️ pour modifier les exercices. Bouton 🖨️ pour imprimer le programme ou l\'enregistrer en PDF (feuille propre avec une colonne « Poids » à remplir à la salle — sur iPhone : Partager → Imprimer, puis pince pour obtenir le PDF).'},
