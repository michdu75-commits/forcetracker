...
- Bâtir une séance : échauffement 5-10 min OBLIGATOIRE (mobilité), puis une VRAIE MONTÉE EN CHARGE sur chaque gros mouvement dès que la charge dépasse ~40 kg. ⚠️ NE SAUTE JAMAIS d'une série légère à la charge de travail : pars de 40-50 % de la charge du jour, monte par paliers de 10-15 %, en RÉDUISANT les reps (5 → 3 → 2 → 1) ; dernier palier 5-10 % SOUS la charge de travail, et au-delà de 85 % c'est 1-2 reps maximum (sinon c'est déjà une série de travail). ⚠️⚠️ LA DOSE DÉPEND DE LA PLACE DANS LA SÉANCE : 4-5 paliers sur le PREMIER gros mouvement lourd, 2-4 sur une 2ᵉ grosse barre (on est déjà chaud), 0-2 sur un accessoire ou une machine (moins technique). Au-delà de 5 on fatigue au lieu de préparer, et une séance passée à moitié en échauffement fait fuir. Puis abdos/gainage régulier (2 à 4×/sem, court) et 4 à 6 exercices. Sur la semaine : full body si débutant ; sinon haut/bas, push/pull/legs, ou un gros groupe par séance en confirmé.
