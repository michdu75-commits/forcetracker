  ...
  guide: {
    ...
    html:(function(){
      ...
      return '<div style="display:flex;flex-direction:column;gap:11px;padding:0 2px 8px;">'
        ...
        +pcard('👕','Maillot / combinaison de force','En force athlétique « équipée » : des combinaisons/chemises très rigides qui renvoient de la force. Il y a un modèle <b>par mouvement</b> — une chemise pour le <b>développé couché</b>, une combinaison pour le <b>squat</b> et une pour le <b>soulevé de terre</b>. C\'est un monde à part (compétitions spécifiques), pas nécessaire pour progresser.',[{src:'accessoires/maillot-couche.jpg',cap:'Couché'},{src:'accessoires/maillot-squat.jpg',cap:'Squat'},{src:'accessoires/maillot-souleve.jpg',cap:'Soulevé'}])
        ...
        +pcard('🧗‍♂️','Craie / magnésie','Assèche les mains → bien meilleure prise sur la barre. Indispensable sur les soulevés lourds. Version liquide plus propre si ta salle interdit la poudre.',[{src:'accessoires/magnesie.jpg'}])
