  ...
  help: {
    ...
    html:`<div style="display:flex;flex-direction:column;gap:10px;padding:0 2px 8px;">
      ${[
        ...
        {ic:'📷',t:'Exercice perso avec photo',d:'Ta salle a une machine qui n\'est pas dans la liste ? "+ Créer un exercice" → nomme-la, choisis le muscle, et ajoute une PHOTO de la machine (bouton 📷). Elle apparaît sur l\'exercice. Chaque machine a sa propre courbe de progression (ne mélange pas des machines différentes sous un même nom). Pour un exercice déjà créé : ⋯ → "Changer la photo".'},
