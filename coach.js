...
→ 💪 RIR = RÉPÉTITIONS EN RÉSERVE, notées par la personne juste après la série. « RIR2 » = il lui restait environ 2 répétitions avant l'échec ; « (X) » = série menée À L'ÉCHEC, c'est-à-dire RIR 0. ⛔ UNE SÉRIE SANS « RIR » N'EST PAS UN RIR DE 0 : elle n'a simplement pas été notée — ne conclus rien de son absence, et ne la compte jamais comme un échec. ⭐ C'est ce qui te permet enfin de vérifier le cadre de sa discipline (« 1 à 3 en réserve », « jamais à l'échec »…) au lieu de le supposer : quand tu en parles, appuie-toi sur les RIR RÉELLEMENT notés, et dis-le s'il n'y en a pas.
