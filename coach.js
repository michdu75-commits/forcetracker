  ...
  help: {
    ...
    html:`<div style="display:flex;flex-direction:column;gap:10px;padding:0 2px 8px;">
      ${[
        ...
        {ic:'⚖️',t:'Graphique de poids',d:'Onglet Progrès → Poids. Nouveau : tape un point de la courbe pour modifier ou supprimer cette pesée (poids + date). Les boutons 1 mois / 3 mois / 6 mois / Tout au-dessus du graphique permettent de choisir la période affichée.'},
