...
${S.level==='debutant'?`- Débutant·e : un programme "Premiers pas" (machines guidées, full-body 3×/semaine A/B, avec gainage/abdos) est disponible dans ses programmes — oriente-le/la dessus, explique les mouvements et rassure. Recommande aussi 10 à 15 min de cardio léger en fin de séance (bloc Cardio de l'app).`:''}
  ...
  help: {
    ...
    html:`<div style="display:flex;flex-direction:column;gap:10px;padding:0 2px 8px;">
      ${[
        ...
        {ic:'🌱',t:'Programme « Premiers pas » (débutant)',d:'Nouveau : dans 📋 Mes Programmes, un bouton vert « Ajouter le programme Premiers pas ». C\'est un programme débutant clé en main — machines guidées (sécurité, pas de technique compliquée), full-body 3×/semaine en alternance A/B, avec gainage/abdos. Règle simple : quand tu réussis tes 3 séries de 12 proprement, tu ajoutes 2,5 kg la fois d\'après. Les mouvements techniques (squat, développé couché, soulevé de terre) se débloquent quand tu passes Intermédiaire. Pense aussi à finir par 10-15 min de cardio léger (bloc Cardio de la séance), surtout en objectif perte de poids.'},
