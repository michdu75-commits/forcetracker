...
- **Version en ligne (live) :** `ft-v660`. Déploiement Pages via GitHub Actions (`.github/workflows/deploy-pages.yml`) — fiable + relançable à la main.
...
>
> **⏭️ CHANTIERS OUVERTS, notés avec Michel les 28-29/07** — ✅ conversation coupée **FAITE (ft-v656)** · ✅ questionnaire qui se répète **FAIT (ft-v657)**. Restent :
...
- **Branche de travail :** `claude/claude-md-docs-ytabnv` — **publiée aussi sur `master`** (donc live = ft-v660). *(session Claude Code web)*
