...
- **Version en ligne (live) :** `ft-v656`. Déploiement Pages via GitHub Actions (`.github/workflows/deploy-pages.yml`) — fiable + relançable à la main.
...
>
> **⏭️ CHANTIERS OUVERTS, notés avec Michel les 28-29/07** — ✅ le n°1 (conversation coupée) est **FAIT en ft-v656**. Restent :
...
- **Branche de travail :** `claude/claude-md-docs-ytabnv` — **publiée aussi sur `master`** (donc live = ft-v656). *(session Claude Code web)*
