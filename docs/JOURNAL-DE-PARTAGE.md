...
|---|---|---|---|---|---|
| 🟡 | 25/08 19:25 | session-A (project-status) | dépouillement du benchmark : 5 vérificateurs qui rougissent À TORT (négation, synonyme, abréviation devenue valide, question légitime, accessoire de santé) + les 3 vrais défauts de Milo | `tests/milo/eval-scenarios.js`, `coach.js` | ft-v1007 (réservée) |
