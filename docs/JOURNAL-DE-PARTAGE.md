...
| 🟡 | 26/08 14:10 | session-A (project-status) | L'APP APPREND l'alimentation du sportif — observateur 100 % LOCAL, zéro appel API (aliments habituels par repas, horaires, moyennes réelles, état de fiabilité nommé) | `app.js`, `screens.js`, `coach.js` | ft-v1021 (réservée) |
