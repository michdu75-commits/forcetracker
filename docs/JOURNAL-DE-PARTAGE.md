...
|---|---|---|---|---|---|
| 🟡 | 26/08 19:20 | session-B (claude-md-docs) | **LE SOCLE DES 8 BRIQUES REMIS À JOUR** — `DOSSIER-ATHLETE-SUIVI.md` n'a pas bougé depuis le **29/07** (~350 versions) et dit **FAUX** : briques 5A/6A marquées « EN ATTENTE » alors qu'elles ont 39 et 41 usages. + le chemin cassé dans `CLAUDE.md` (`docs/` alors que le fichier est à la racine) + un générateur `tools/briques.py` | `DOSSIER-ATHLETE-SUIVI.md`, `CLAUDE.md`, `tools/briques.py`, `tools/check_regles.py` | — (gouvernance) |
