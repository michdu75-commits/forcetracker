...
| 🟡 | 26/08 13:50 | session-A (project-status) | « ce qu'il te reste » SIMPLIFIÉ — Michel : *« il faut rester simple, tout le monde ne bouffe pas de flocons d'avoine »* : un aliment par ligne, et on classe par ce qu'il mange SOUVENT | `app.js`, `screens.js` | ft-v1020 (réservée) |
