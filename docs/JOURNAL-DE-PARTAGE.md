...
|---|---|---|---|---|---|
| 🟡 | 26/08 08:32 | session-A (project-status) | ① l'export « avec mes discussions » PERD le fil en cours et emporte les consignes internes `_silent` · ② le bouton d'export texte sort de l'Admin | `coach.js`, `index.html` | ft-v1013 (réservée) |
