...
|---|---|---|---|---|---|
| 🟡 | 26/08 20:15 | session-A (project-status) | **CE QUE L'APP A APPRIS : trois défauts vus sur une VRAIE capture d'écran de Michel** — ① « répartis sur 50 » (un nombre sans unité) · ② « 1920 kcal » sans séparateur alors que « 2 495 » est juste dessous · ③ ⭐ **deux moyennes qui se contredisent à l'œil** (1 920 vs 2 495) sans que rien ne dise que l'une porte sur TOUT le journal et l'autre sur 7 jours glissants. | `screens.js`, `tests/parcours/runner.js`, `sw.js` | ft-v1026 (réservée) |
