...
| 🟡 | 26/08 13:10 | session-A (project-status) | NUTRITION : « ce qu'il te reste à manger aujourd'hui » — traduit en ALIMENTS À TOI (trou 3.3 : le Journal et le Plan s'ignoraient) | `app.js`, `screens.js` | ft-v1019 (réservée) |
