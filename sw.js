 ...
 */
const CACHE = 'ft-v1111'; // 🔢 ft-v1111 = LE CALIBRAGE GARDE LA DECIMALE DE L ETIQUETTE. Michel envoie enfin le tableau complet de son pot : 388,5 kcal / 88 g de proteines / 2,8 g de glucides / 3,3 g de lipides pour 100 g -- et l etiquette declare elle-meme une PORTION DE 30 g, ce qui elimine l hypothese des 40 g venus de la fiche produit : les 156 kcal / 35 g etaient bien une estimation inventee. MESURE : le calibrage de ft-v1110 rend 117 / 26 / 1 / 1 pour ses 30 g (etiquette 116,6 / 26,4 / <1 / 1,0), donc juste. MAIS la mesure montre un defaut : 2,8 et 3,3 etaient STOCKES arrondis a 3. Invisible sur une poudre de proteine, destructeur ailleurs -- une huile a 0,4 g/100 g voyait sa valeur devenir 0, l app effacant un chiffre que la personne venait de recopier. On transcrit ce que la personne a LU, on ne l arrondit pas a sa place (lecon de ft-v1100). ET CA NE CHANGE RIEN A L AFFICHAGE : _qtyRescale arrondit deja les 4 champs a l entier en les ecrivant ; la decimale ne sert qu a ce qui est CONSERVE. Un seul fichier touche cote app (_calAppliquer). Tests : parcours (bloc CCXIX, +2 temoins), calculs 266, muscles 241, croises 50, dates 7, donnees 0 trou.
