 ...
 */
const CACHE = 'ft-v1108'; // ⚖️ ft-v1108 = LA BARRE DES JOURNEES EXPLOITABLES PASSE DE LA MEDIANE A SES DEUX TIERS. GPT/Michel demandent un contre-audit de la regle sur le VRAI journal exporte. ⚠️⚠️ LA REGLE QUE J'AVAIS LIVREE LA VEILLE ETAIT FAUSSE, et c'est la mesure qui le dit : sur la structure reelle de Michel (11 jours a 4-5 moments) contre les 9 cas de l'audit, la MEDIANE NUE produit **2 FAUX INVALIDES** — une VRAIE journee a 3 repas est ecartee, et un CHANGEMENT DURABLE 4 repas -> 3 repas fait ecarter 4 jours sur 5 le temps que la mediane rattrape. 👉 ***Une mediane exclut par construction ce qui est en dessous*** : elle ne distingue pas « journee inhabituelle » de « journee mal renseignee », qui est exactement la distinction demandee. ⭐ MESURE SUR 5 FRACTIONS (1/3 · 1/2 · 2/3 · 3/4 · mediane nue) : toutes sauf la mediane nue donnent **0 faux valide ET 0 faux invalide** sur les 9 cas ; elles ne se distinguent QUE sur le cas ambigu (2 repas / 402 kcal). **Michel a tranche : ecartee** -> deux tiers. ⛔ ET LA FRACTION RESTE UN CHOIX, PAS UNE MESURE : c'est le seul parametre libre de la regle, ecrit dans le code pour qu'on sache quoi rouvrir. ⭐ VERIFIE SUR LES 9 CAS : journal reel de Michel **0 jour ecarte** (moyenne 2 313, GPT mesure 2 312) · vraie journee a 3 repas **gardee** · 4 repas a 1 200 kcal **gardee** (les calories ne sont JAMAIS le critere) · 1 repas / 1 entree **ecartee** · 2 repas / 402 kcal **ecartee** · 1 enorme repas a 1 800 kcal **ecarte** · jeune intermittent (2 repas toujours) barre 2 **0 ecarte** · OMAD barre 1 **0 ecarte** · changement durable **0 ecarte**. ⛔ LE PLANCHER A 1 PROTEGE L'OMAD : sans lui la barre tomberait a 0 et la regle n'ecarterait plus rien chez quelqu'un qui mange une fois par jour. ⚠️ LE CSV REEL N'ETAIT PAS DANS LA SESSION : je travaille sur les mesures par jour relayees par GPT (entrees/repas/kcal), je ne peux ni les verifier ni calculer ce qu'il n'a pas relaye. Dit plutot que sous-entendu. Tests : parcours 2459 (bloc CCXVI, +13), calculs 266, muscles 241, croises 50, dates 7, donnees 0 trou.
