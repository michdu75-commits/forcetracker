 ...
 */
const CACHE = 'ft-v1110'; // ⚖️ ft-v1110 = UN PRODUIT DEVIENT CALIBRABLE A LA MAIN. Michel, 4e passe sur le meme pot d isolat : « il y a toujours le probleme avec ma prot, comment on peut resoudre ce probleme ». MESURE, ET LA CAUSE EST STRUCTURELLE : sa ligne porte per100=null, et AUCUN champ de l app ne permettait de saisir un pour-100 g a la main -- ce chiffre n arrivait que d un scan ou de CIQUAL. Un produit dont la fiche est incomplete restait donc INCALIBRABLE A VIE, et sa vieille ligne fausse revenait en tete des propositions : un tap, et l erreur recommencait. LES TROIS VERSIONS PRECEDENTES (ft-v1103/1104/1105) ONT AJOUTE DES ALERTES ; aucune n a rendu la personne capable de REPARER le produit. Un garde-fou dit que c est faux, il ne corrige pas. ZERO NOUVEAU CALCUL (R13/R2) : on rejoint le chemin de CIQUAL, qui appelle deja _offRemplirFormulaire avec un produit vide -- meme bloc quantite, meme recalcul, meme per100 enregistre. MESURE SUR SON ETIQUETTE : 88 g de proteines / 100 g -> 30 g rendent 26 g, le per100 descend jusqu a la DONNEE (R4) et la fois d APRES la proposition le porte -- c est le mot « toujours » qui est traite, pas un repas. LA PROVENANCE NE MENT PAS (R33) : marquee « etiquette », jamais « off ». LA REGLE PHYSIQUE DE ft-v1103 EST REUTILISEE (un seul proprietaire) : une colonne « par portion » recopiee dans « pour 100 g » est refusee, et le texte dit quoi faire au lieu d accuser (R29). Tests : parcours (bloc CCXIX), calculs 266, muscles 241, croises 50, dates 7, donnees 0 trou.
