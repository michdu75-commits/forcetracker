 ...
 */
const CACHE = 'ft-v963'; // 🔎 ft-v963 = LE PLURIEL — 97 % DE LA BASE ETAIT INATTEIGNABLE. Michel : « c'est comme j'ai cherche les pates, j'ai pas trouve — enfin si, mais pas ce que je voulais trouver, et je n'ai plus la boite pour le code-barre ». ⚠️⚠️ ET SA PROPRE EXPLICATION ETAIT FAUSSE : il a pense a l'accent (« ah c'est pates et pas pates lol »). VERIFIE — « pates » et « pates » rendent EXACTEMENT la meme liste depuis ft-v960, NFD retire les accents. Le croire aurait ferme le sujet sur un faux coupable et laisse le vrai en place : R28 coupe dans les deux sens, y compris quand c'est Michel qui diagnostique. ⛔⛔ LE VRAI DEFAUT, MESURE SUR TOUTE LA BASE : CIQUAL nomme au SINGULIER (« Amande, grillee », « Lentille verte », « Tomate, crue ») et les gens tapent au PLURIEL — on mange DES amandes. 97 % des 3 341 aliments etaient inatteignables. ⭐⭐ ET LE PIRE N'EST PAS LE VIDE, C'EST LE FAUX : les PLATS composes, eux, emploient le pluriel — « amandes » rendait Croissant aux amandes, « lentilles » rendait Soupe aux lentilles, « tomates » rendait Caviar de tomates. Une recherche qui rend le mauvais aliment coute plus cher qu'une recherche vide : on l'enregistre sans se mefier. ⛔ MEME TROU EN VOCABULAIRE POUR LES PATES : CIQUAL ne connait que « Pates seches » — penne, macaroni, coquillettes, fusilli, farfalle, rigatoni, conchiglie, linguine rendaient ZERO resultat, et « spaghetti » rendait LA COURGE SPAGHETTI. C'est tres probablement ce que Michel a vu. ⚠️ Ce ne sont pas des aliments differents, ce sont des formes de la meme semoule : on n'invente aucune valeur, on ouvre une porte vers celles de CIQUAL. ⭐⭐ L'ORDRE DE PREFERENCE EST CE QUI EVITE LES DEGATS, ET IL A FALLU DEUX ESSAIS : mon 1er jet retirait le « s » sans plus de facons, et fabriquait deux regressions — « pates » rendait PATE BRETON, « pois » rendait POIREAU. On classe donc : le nom COMMENCE par le mot > la forme EXACTE avant la depluralisee > le nom le plus court. Mesure : 0 regression sur 50 requetes courantes. ⭐ R2 — UN SEUL PROPRIETAIRE DE « CHERCHER » : les trois recherches (CIQUAL, complements, et SON PROPRE JOURNAL) avaient le meme defaut, elles le corrigent au meme endroit — sinon la prochaine correction n'en reparerait qu'une et personne ne le verrait. ⚠️ Le plafond de 400 reste tel quel : mesure, il ne fausse qu'« eau » (robinet au lieu de coco), et les deux se valent.
const PRECACHE = [
