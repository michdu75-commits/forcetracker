 ...
 */
const CACHE = 'ft-v997'; // 🧬 ft-v997 = UN NOM ABREGE LIT LA FICHE ECRITE, PLUS LA DEVINETTE. Le 2e effet de la meme cause que ft-v996, tranche par Michel apres mesure : « fais la correction des muscles aussi ». ⛔⛔ _mscScores cherchait la fiche avec le nom EXACT : un nom ABREGE (« Hip Thrust Barre ») la ratait et retombait sur les regles _MEX, qui DEVINENT — c'est-a-dire l'inverse exact de ce que le bloc annonce depuis le 02/08 (« la donnee ecrite passe avant les regles »). MESURE AVANT DE CODER : 55 des 77 abreviations rendaient des muscles DIFFERENTS, et « Inclinaison Lombaire » n'en rendait AUCUN (figurine entierement grise). ⭐ L'EXEMPLE QUI COUTE : « Rowing Poitrine Appuyee » abrege RECREDITAIT le bas du dos, que la fiche du 02/08 avait retire EXPRES (poitrine appuyee = colonne non chargee) — une correction anatomique faite a la main, perdue des que le nom etait abrege. ⭐⭐ ET SA JUMELLE, TROUVEE EN LA CHERCHANT (R8 — « un oubli de ce type est rarement isole ») : estUnilateral/uniLabel avaient le MEME defaut. 10 exercices perdaient leur statut unilateral une fois abreges (Hip Thrust Unilateral, Montee sur Box, Arrache Haltere...) → leur volume n'etait PAS double et l'etiquette « par bras / par jambe » ne s'affichait pas. ⛔ LES CALORIES SUIVENT SANS LIGNE SUPPLEMENTAIRE : le MET derive des muscles, donc 4 exercices avaient un MET faux — jusqu'a ±62 % sur la seance (Inclinaison Lombaire 4 vs 6,5 ; Extension Fessiers Arriere 6,5 vs 4, qui SURESTIMAIT). ⛔⛔ UN ENDROIT RESTE STRICT, ET C'EST ECRIT DANS LE CODE (R30) : state.js, la fusion des exercices perso avec le catalogue. Y resoudre l'abreviation rendrait l'operation DESTRUCTRICE — quelqu'un qui a cree son propre « Hip Thrust Barre » avec sa photo le verrait disparaitre. Une LECTURE qui se trompe coute une figurine ; une SUPPRESSION qui se trompe coute le travail de la personne (R29). ⛔ Les regles _MEX et les exercices perso gardent le nom D'ORIGINE, exprès : ils travaillent sur ce que la personne a ecrit, pas sur le catalogue. ⚠️ CE QUI CHANGE POUR L'UTILISATEUR, ET IL FAUT LE LIRE : la figurine, la couleur du calendrier, les calories et le volume de seances DEJA PASSEES bougent — c'est le prix de la correction, et c'est Michel qui l'a tranche en connaissance de cause. Rien n'est reecrit en base : tout est recalcule a l'affichage, donc reversible.
const PRECACHE = [
