 ...
 */
const CACHE = 'ft-v899'; // 🥗 ft-v899 = LE PLAN ALIMENTAIRE DONNE ENFIN SES PORTIONS, et le check-in se replie. Deux retours de Michel. (1) « le check-in du jour ne se ferme pas quand on a enregistre » : le bouton Enregistrer du sommeil est le DERNIER element de la carte, une fois touche on a fini de la remplir -> elle se replie sur son resume. Rien d'autre ne la ferme : energie/moral/douleurs sont des boutons a un appui, on peut vouloir en toucher plusieurs. (2) « dans nutrition le plan alimentaire du jour il n'y a pas les proportions » : le plan affichait « Avoine + oeufs + fruit » sans aucune quantite. Il affiche desormais « Avoine 80 g + oeufs 180 g + fruit 150 g », calcule depuis les calories du repas. ⚠️⚠️ TOUT EN GRAMMES, JAMAIS EN PIECES, et ce n'est pas un choix de style : les descriptions passent par _adaptMealDesc() qui REMPLACE des aliments (vegan, sans gluten, allergies). « Oeufs (3) » deviendrait « Tofu (3) » = trois tofus. Les portions sont donc calculees APRES l'adaptation, sur l'aliment REELLEMENT affiche. ⚠️ ON N'INVENTE RIEN : un aliment absent de la table ne recoit AUCUNE quantite (R29) — mieux vaut « + legumes » que « + legumes 137 g » sorti de nulle part. Et une quantite deja ecrite dans le plan (« Amandes (20g) ») n'est jamais doublee (R30). ⚠️ Les legumes et les fruits ont une PORTION STANDARD : repartir les calories au prorata donnait « fruit 280 g » a un petit-dejeuner. ⭐ TROIS DEFAUTS TROUVES PAR LES TESTS, PAS A L'OEIL : la quantite collee a la fin d'une preparation (« a l'huile d'olive 200 g » = 200 g d'HUILE) -> elle se pose APRES l'aliment ; l'unite lue dans le TEXTE alors que le mot « huile » apparait dans une phrase sur les oeufs -> elle vient de la table ; et le motif `b[œo]euf` qui ne matchait JAMAIS « bœuf ». ⏭️ La variation JOUR PAR JOUR n'est PAS faite : elle demande un vrai jeu de variantes, et chaque aliment ajoute doit etre connu des tables de substitution et d'allergenes — sinon un vegan voit de la viande.
const PRECACHE = [
