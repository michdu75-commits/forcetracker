 ...
 */
const CACHE = 'ft-v1054'; // ⏳ ft-v1054 = LA SEANCE D'HIER NE RESSURGIT PLUS. Michel, DIX MINUTES apres ft-v1053 : « lol il vient de me sortir la seance d'hier ». ⛔⛔ LE DEFAUT VIENT DE ft-v1051, MESURE DES DEUX COTES avant de le dire (une seance de 26 h ressurgissait ET s'injectait contre ft-v1052 COMME contre ft-v1053). Sa borne etait « au plus 3 messages de Milo » : un NOMBRE DE MESSAGES, c'est-a-dire un PROXY de « recent » — or le fil du chat SURVIT AUX JOURS. ⚠️ ft-v1053 ne l'a pas cause, il l'a rendu FORT : un bouton nu passait inapercu, une carte qui demande « Cette seance te convient ? » se lit comme une proposition d'aujourd'hui. 👉 Borne en TEMPS : meme jour civil OU moins de 12 h (l'union, parce que ① demander le matin et ouvrir a la salle le soir est le cas d'origine de ft-v851, et ② la demande de 23 h deborde sur la nuit). ⚠️⚠️ ET LE CAS « PAS DE DATE » A ETE TRANCHE SUR UNE MESURE : `ts` n'existe que depuis le 25/08, donc repondre « non » aurait RETIRE le bouton a tout fil plus ancien — une 4e panne fabriquee en reparant la 3e. Un message sans date herite de l'age de sa CONVERSATION (`ft4_coach_lastts`), et sans rien du tout on garde le comportement d'hier.
const PRECACHE = [
