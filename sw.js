 ...
 */
const CACHE = 'ft-v1076'; // 🗂️ ft-v1069 = LE HAUT DE PROGRES : ONGLETS EN TETE, CARTES REPLIABLES. Michel, capture a l'appui : « ca prend vachement d'espace en haut non ? ». ⭐ MESURE AVANT : synthese 216 px + volume 345 px (8 muscles) = **561 px** — les sous-onglets tombaient a **y=699** sur un ecran de 844, et le champ de recherche a **821, AU RAS DU BORD** : sur l'onglet Exercices, sa progression commencait HORS ECRAN. ⭐⭐ DEUX RAISONS, la seconde de fond : ① les onglets sont de la NAVIGATION, elle doit etre atteignable sans defiler ; ② depuis ft-v1065 ces cartes n'appartiennent qu'a l'onglet Exercices — leur place est DANS son contenu, pas au-dessus de la barre qui sert a en sortir. ⭐ APRES : onglets **y=118**, les 2 cartes repliees tiennent en **132 px**, PROGRESSION a **347** et la recherche a **392**. ⛔ L'ETAT EST RETENU (`ft4_progAcc`) : *un accordeon qu'on doit rouvrir a chaque visite est un accordeon qu'on n'ouvre plus* (lecon de ft-v1024). ⛔ On MASQUE, on ne vide ni ne recalcule (R19/R2). ⛔ R13 : `details.acc` existait deja — ZERO ligne de CSS ajoutee, seulement une regle qui NEUTRALISE l'encadre interieur. ⚠️ Le titre etait DOUBLE (le resume + la carte) — trouve a la CAPTURE, invisible a toute mesure de chaine. ⚠️ Et le lisere de ft-v1047 est retire : il distinguait deux cartes grises identiques, chacune a desormais son titre — *on ne garde pas un repere visuel dont la raison a disparu* (R30), le temoin est re-vise sur la DISTINCTION.
