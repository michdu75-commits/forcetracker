 ...
 */
const CACHE = 'ft-v1112'; // 🔢 ft-v1112 = UNE SEULE PRECISION POUR LE POUR-100 g. Michel : « ca va etre comme ca sur tous les produits, c est chiant ? ». La reponse est NON (3 484 aliments embarques, code-barres, photo d etiquette) -- MAIS LA VERIFICATION A TROUVE PIRE QUE SA QUESTION. SIX endroits construisent _bcNutr, QUATRE arrondissaient a l entier : code-barres OFF, recherche OFF, base CIQUAL, et les calories de la photo d etiquette. Seuls le calibrage a la main (ft-v1111) et les macros de la photo gardaient la decimale -- six ecritures de la meme idee, quatre comportements. LE PLUS COUTEUX EST LA BASE EMBARQUEE, celle qui sert le plus : data/ciqual.json CONTIENT les decimales et l app les jetait a la lecture. MESURE : 3 298 aliments sur 3 484 portent au moins une decimale, et 1 159 ont une macro entre 0 et 1 g/100 g -- arrondie, elle devient 0 ou 1, soit 100 % d erreur sur cette macro. Verifie sur la salade de celeri remoulade : 0,9 / 3,1 / 10,2 conserves la ou l ancien code rangeait 1 / 3 / 10. LA PHOTO D ETIQUETTE : le serveur demandait deja « garde 1 decimale si presente » et l app jetait les CALORIES a l arrivee (R4 pur). ET CA NE CHANGE RIEN A L ECRAN : _qtyRescale arrondit deja les champs en les ecrivant ; la decimale ne sert qu a ce qui est CONSERVE et re-multiplie. C est R8 (la jumelle) pour la 5e fois cette semaine : le correctif de la veille etait pose sur 1 endroit des 6, et pas sur le plus utilise. Tests : parcours (bloc CCXX), calculs 266, muscles 241, croises 50, dates 7, donnees 0 trou.
