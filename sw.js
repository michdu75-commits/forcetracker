 ...
 */
const CACHE = 'ft-v951'; // 🍚 ft-v951 = LES GLUCIDES PLUS HAUTS LES JOURS DE SEANCE. Michel : « les glucides plus hauts les jours de seance et adaptes ». ⭐⭐ LE LEVIER N'EST PAS LES GLUCIDES, CE SONT LES LIPIDES : dans le calcul standard, proteines et lipides sont fixes au POIDS DE CORPS et les glucides sont le RESTE. Il n'y a donc rien a « ajouter » aux glucides — pour qu'ils montent a calories constantes, ce sont les lipides qui descendent, et qui remontent les jours de repos. C'est aussi le bon geste physiologiquement : les glucides alimentent l'effort, les lipides sont le carburant des jours calmes. ⛔⛔ ET LE TOTAL DE LA SEMAINE NE BOUGE PAS D'UN GRAMME — c'est la condition, pas un detail : monter les glucides des jours de seance sans les baisser ailleurs, ce n'est pas du cycling, c'est manger plus sans le dire (R29). La compensation est calee sur la FREQUENCE reelle : on retire D(7-f)/7 les jours de seance, on ajoute Df/7 les jours de repos — somme exactement nulle quelle que soit f, verifie de 1 a 6 seances/semaine. ⚠️ LES CALORIES DU JOUR NE BOUGENT PAS NON PLUS : on echange des lipides contre des glucides, l'anneau ne bouge pas. ⭐ « ET ADAPTES » : une seance de JAMBES donne plus qu'une seance de BRAS (facteur de region), et la neutralite tient quand meme parce que les jours de repos rendent la moyenne des facteurs de SES propres seances. ⛔⛔ NI EN KETO NI EN LOW CARB : le pourcentage de glucides DEFINIT le regime — le faire varier sortirait la personne de son regime sans le lui demander. ⚠️ Plancher lipidique 0,6 g/kg, ECRIT comme un choix : le Gardien de Milo n'a aucun seuil sur les lipides (verifie). ⚠️ ET UN ARRONDI APPLIQUE TROP TOT DEVIENT UN BIAIS : arrondir les lipides avant de calculer le reste injectait ~1 g d'erreur par jour qui ne se compensait PAS entre seance et repos (jusqu'a 9 g sur la semaine, mesure par le temoin de neutralite).
const PRECACHE = [
