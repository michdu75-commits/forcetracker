 ...
 */
const CACHE = 'ft-v1109'; // 📌 ft-v1109 = LA LIGNE « REPAS » RESTE A L'ECRAN, ET LA CONFIRMATION DIT OU. Michel, deux captures de la modale d'ajout : « il faudrait que les ronds en haut soient fixes quand on descend, et pareil quand on rentre un aliment quel est le jour de la journee choisi ». MESURE AVANT DE CODER : les puces sortaient de l'ecran des 236 px, sur une modale qui en defile 951 -- or TOUT ce qui sert a saisir l'aliment (champ, estimation IA, quantite, macros) vit EN DESSOUS. Au moment precis de valider, le repas qui recoit l'aliment n'etait donc JAMAIS visible. ET IL EST SOUVENT DEVINE : _afMeal est pre-regle sur l'heure qu'il est -- une supposition qu'on ne montre pas est une decision prise a la place de la personne (R29). RIEN N'EST INVENTE (R13) : c'est l'en-tete collant deja employe par #ov-help et 3 autres modales. LE DEFAUT DE MA 1re VERSION A ETE TROUVE PAR LA CAPTURE, PAS PAR LES CHIFFRES : avec top:0 les aliments defilaient dans les 16 px de marge AU-DESSUS de la bande, et tous les nombres etaient pourtant bons. LA JUMELLE (R8) : « tes repas habituels » nommait deja le moment depuis ft-v1052, avec la raison ecrite -- les DEUX autres chemins d'ajout disaient toujours « Ajoute au journal ». Une regle ecrite pour un chemin et pas pour ses jumeaux est une regle a moitie appliquee. Un seul proprietaire : _foodMealInfo (R2). COUT MESURE ET BORNE : la bande prend 98 px sur 775. Et les puces passent de 70 a 64 px de large pour tenir sur UNE ligne a 390 px (elles se cassaient en 4+1, soit 114 px au lieu de 71) ; sur les grands iPhone flex:1 repartit tout, rien ne change. CONTROLE NEGATIF joue contre le code d'hier : invisibles des 300 px, position static, 2 lignes a 390 px, aucun proprietaire du libelle. Tests : parcours 2486 sur l arbre fusionne (bloc CCXVIII, +20 de moi), calculs 266, muscles 241, croises 50, dates 7, donnees 0 trou.
