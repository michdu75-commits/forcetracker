 ...
 */
const CACHE = 'ft-v920'; // 🛡️ ft-v920 = LE MODELE PROPOSE, LE CODE VALIDE. On DEMANDAIT au cervelet de reprendre le nom d'exercice « exactement tel que le coach l'a ecrit » ; personne ne le VERIFIAIT. S'il rendait « Developpe Incline » la ou Milo avait ecrit « Developpe Couche », la personne s'entrainait sur autre chose SANS UN MESSAGE. ⚠️⚠️ ET LA REGLE EXISTAIT DEJA, appliquee au SEUL chemin en code : `_seanceDepuisTexte` refuse le rapprochement « par mots » depuis le 04/08, avec sa mesure (il transformait « Curl Biceps Halteres » en « Curl Barre »). La conclusion d'alors — pour CONSTRUIRE une seance on refuse le « a peu pres » — n'avait jamais ete portee jusqu'au cervelet. BUGS.md famille 15, la regle juste definie trop etroit, 3e fois en trois jours. 👉 LA REGLE, simple et explicable : chaque nom rendu doit se retrouver dans le texte de Milo — au moins un mot significatif ET la moitie de ses mots. « Developpe Couche Barre » passe (une precision de catalogue n'est pas une invention), « Developpe Incline Halteres » non. ⚠️ ON N'AVERTIT PAS la personne, et c'est reflechi : ce qu'on retire, elle ne l'a JAMAIS VU — l'ecarter REMET la seance en accord avec ce qu'elle a lu. ⚠️ Et si la traduction est trop abimee (moins de 2 survivants, ou plus d'un tiers ecarte), on ne rafistole pas : on rend null et la cascade repart sur le filet deterministe, fidele PAR CONSTRUCTION. Une seance a moitie juste est pire qu'une seance plus pauvre mais vraie (R29).
const PRECACHE = [
