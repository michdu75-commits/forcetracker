 ...
 */
const CACHE = 'ft-v1023'; // 🏗️ ft-v1023 = LE GENERATEUR DE PROGRAMMES SORT DU CADRE « DEBUTANT ». Brique ④ du chantier ecran Seance (docs/SEANCE-DESSAI.md §5). ⚠️⚠️ EN MESURANT, LE VERROU N'ETAIT PAS LA PORTE : le bouton etait deja visible pour tout le monde. Ce qui enfermait le generateur, c'etait le VOCABULAIRE (« parcours debutant », « Premiers pas »), le CONTENU (100 % machines guidees), le blocage ONE-SHOT (« tu as deja ton programme debutant » — vrai pour un parcours de 12 semaines, absurde pour un generateur), et un `beginnerJourney` pose MEME POUR UN CONFIRME. ⛔⛔ OUVRIR LA PORTE SANS TOUCHER AU CONTENU AURAIT ETE PIRE QUE DE NE RIEN FAIRE (3e cas de R30) : on aurait livre un programme tout-machines a quelqu'un qui squatte a la barre. 👉 D'OU LA 3e QUESTION — « avec quoi tu t'entraines ? » machines / barres et halteres — deterministe, aucune IA, et c'est exactement ce que le §2.3 du cadrage demandait. ⭐ UNE SEULE LISTE, TRADUITE A LA SORTIE (R2) : deux catalogues paralleles divergeraient, on corrigerait un desequilibre d'un cote et pas de l'autre. ⛔ Les 16 equivalences sont VERIFIEES CONTRE LE CATALOGUE (324 noms), pas ecrites de memoire — un nom inconnu produirait un exercice sans animation, sans muscles et sans MET, invisible avant la salle (R29). ⛔⛔ ET `beginnerJourney` NE SE POSE QUE S'IL EST DEMANDE : avant, un confirme qui generait un programme se retrouvait inscrit en « phase 1 debutant », avec l'objectif d'etape affiche, sans moyen d'en sortir. *C'est ecrire un fait faux sur quelqu'un.* ⭐ Un seul proprietaire pour la condition (`_bgEstParcoursDebutant`) : trois endroits en dependent. ⚠️ ET LA CAPTURE A MONTRE UNE COCHE QUI MENT : « 3 seances ✅ » etait ecrit EN DUR, donc elle restait sur 3 apres avoir choisi 2 — l'ecran affichait la selection en rouge ET une coche qui la contredisait.
const PRECACHE = [
