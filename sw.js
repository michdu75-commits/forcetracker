 ...
 */
const CACHE = 'ft-v1052'; // 🎽 ft-v1052 = LE REPOS SUIT LA CHARGE, PAS L'OBJECTIF — chez Milo ET a l'ecran. Ne des captures de Michel en salle (48 ans) : « quand on fait de la force, 1 min 30 c'est impossible, il faut la recup ». ⛔⛔ MESURE : Milo recevait « muscle → 8-15 reps, repos 60-90 s » ET le cadre muscu « 90 a 150 s », et RIEN qui lie le repos a la CHARGE — sur un 95×3 a 88 % du 1RM il prenait donc les REPS DE LA FORCE et le REPOS DE L'HYPERTROPHIE. Un melange, pas un choix. ⛔ Les nombres ne sont PAS reecrits dans le prompt (R2) : la consigne est DERIVEE de `_INT_LOURD` et `_cadreReposLourd` — change de discipline et la phrase suit toute seule. ⛔⛔ 2e point : le controle d'intensite existait depuis ft-v980 mais ne s'affichait qu'a l'APPLICATION, dans l'ecran Seance. Michel lit le CHAT : il n'y voyait rien, donc pour lui il n'existait pas (R3 — une connaissance sans comportement observable). Greffe sur `_appendStartSessionBtn`, le passage oblige des TROIS voies. ⛔ R24 : ca informe, ca ne bloque pas — le bouton reste. ⛔ R29 : la charge et les reps de Milo ne sont PAS retouches.
const PRECACHE = [
