 ...
 */
const CACHE = 'ft-v1128'; // 👥 ft-v1128 = « ANON » N EST PAS QUELQU UN. Michel, devant l ecran : « c est qui anon ? il faut que je sache qui utilise Milo ». MESURE SUR SA JOURNEE, ET L ARITHMETIQUE FERME EXACTEMENT : 25 appels, michdu75 16 + anon 9 -- et les 9 se decomposent en 5 seanceJson (qui n envoie aucun e-mail) + 4 de la passe A/B (ecrite la veille avec coachEmail vide en dur). LES DEUX ETAIENT LUI : l ecran annoncait « 2 personnes » pour une seule. ET LES DEUX CAUSES NE SE TRAITENT PAS PAREIL, c est tout le sujet. Le mien est un DEFAUT : _evRun passe S.email depuis le 29/08 expres, je ne l ai pas fait -- sans e-mail l appel tape dans le quota PARTAGE anon (50/jour) au lieu du sien, et worker.js l ecrit noir sur blanc. Corrige. Mais seanceJson a RAISON de ne rien envoyer : c est le cervelet, dont le critere est « ca n a pas besoin de savoir QUI est la personne », et un temoin fige son appel a EXACTEMENT 2 cles -- le reparer casserait l architecture (R30/R28 : chercher la decision avant de reparer ce qui ressemble a un oubli). UN COMPTEUR D IDENTITES QUI N EN RECOIT PAS NE COMPTE PAS DES GENS, IL COMPTE DES TROUS -- et le trou se NOMME, il ne se bouche pas. L ecran retire donc anon du COMPTE de personnes et dit ce qu il est, avec sa raison. Un temoin de controle verifie que DEUX vraies personnes comptent bien 2, sinon « toujours 1 » serait vert. Panneau admin + laboratoire : aucun ecran public touche. Tests : parcours (bloc CCXXXIII), calculs, muscles, croises, dates, donnees.
