 ...
 */
const CACHE = 'ft-v908'; // 🔄 ft-v908 = TROIS DEFAUTS DU VOLET SUPPLEMENTS, TROUVES PAR LE CONTRE-AUDIT v1.2 ET VERIFIES LIGNE PAR LIGNE. ① UNE PHRASE FAUSSE ETAIT AFFICHEE : « la cafeine reduit l'absorption de la creatine, espace-les de 2 h ». L'absorption n'est PAS en cause (Vandenberghe 1996, Vanakoski 1998) ; un antagonisme existe ailleurs, sur la relaxation musculaire (Hespel 2002), et les travaux DIVERGENT ; l'espacement de 2 h n'a JAMAIS ete teste — et la demi-vie de la cafeine est de ~5 h, donc decaler de 2 h ne change rien. On dit desormais ce qui est mesure, ce qui est debattu, et ce qui n'a pas ete teste. ② LES CONTRE-INDICATIONS DE L'ANSES N'ETAIENT AFFICHEES NULLE PART : maladie renale, risque cardiovasculaire, cardiopathie, atteinte hepatique, troubles neuropsychiatriques, mineurs, grossesse/allaitement + ne pas cumuler les sources + normes NF V 94-001 / EN 17444:2021. C'est le seul point du dossier qui releve vraiment de la SECURITE. On renvoie au medecin, on n'interdit pas (Constitution), et ce n'est pas affiche en rouge (P21). ③ LA BARRE DE PROTEINES NE LISAIT PAS LE JOURNAL : `prot-eaten` etait une saisie manuelle que RIEN n'alimentait — deux systemes de suivi proteique dans la meme app, dont un qui ignorait l'autre (R2 + R4). Mesure : avec 60 g deja notes, l'app affichait « il te reste 187 g » sur une cible de 187. La saisie manuelle reste prioritaire quand elle est remplie. ⚠️ LA DOSE DE CREATINE N'EST PAS CHANGEE, ET C'EST DELIBERE : la formule 0,05 g/kg plafonnee a 5 g n'a AUCUNE source, et la dose journaliere maximale francaise est de 3 g (arrete du 26/09/2016, ANSES 2023-SA-0216). Mais baisser la recommandation par defaut de tout le monde est une decision produit ET de sante — elle appartient a Michel. En attendant on AFFICHE le repere reglementaire au lieu de le taire.
const PRECACHE = [
