 ...
 */
const CACHE = 'ft-v910'; // 🔄 ft-v910 = LA DOSE DE CREATINE EST LIBRE, ET C'EST L'AVERTISSEMENT QUI REMPLACE LE PLAFOND. Decision Michel : « pour moi on laisse le champ libre et il n'y a pas de taux legal en France, mais avec un avertissement au-dela de 3-5 grammes ». ⚠️⚠️ ET IL A RAISON, J'AVAIS ECRIT FAUX : l'arrete du 26/09/2016 fixe 3 g/j pour les complements VENDUS en France — ca engage le FABRICANT (ce qu'il a le droit de commercialiser et d'etiqueter), PAS le consommateur. Personne n'est hors la loi en prenant 5 g. Parler de « maximum legal » faisait passer un repere de commercialisation pour une interdiction. DEUX SEUILS, DEUX TONS (R11) : au-dela de 3 g un simple REPERE qui dit que c'est une regle de commercialisation ; au-dela de 5 g un AVERTISSEMENT — on sort de ce que decrivent les societes savantes, les preuves au long cours y sont limitees, et ce n'est PAS un danger demontre. En dessous de 3 g : rien du tout, on n'encombre pas pour rien. ⚠️ Bornes de saisie volontairement LARGES (0,5 a 30 g) : elles n'existent que pour attraper une faute de frappe, pas pour brider un choix — 30 g/j sur 5 ans est documente comme tolere chez des sujets sains (Kreider 2017). Retour a la suggestion de l'app en un geste.
const PRECACHE = [
