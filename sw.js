 ...
 */
const CACHE = 'ft-v913'; // 💊 ft-v913 = LA FICHE CREATINE S'OUVRAIT SUR 20 g/JOUR, dans une app qui AVERTIT au-dela de 5 g. Trouve par une revue UX exterieure (GPT + une autre instance Claude) sur le dossier de 12 captures que j'avais fabrique. ⚠️⚠️ ET LE CONSTAT QUI COMPTE EST SUR MA METHODE : mon dossier annoncait « verifie en JOUANT le parcours, pas en le decrivant » — et trois de ses captures creatine etaient IDENTIQUES, parce que je n'avais pas applique le parcours a l'onglet Supplements. C'est en cherchant POURQUOI qu'on est tombe sur le vrai defaut : `creatPhase` demarrait a 'charge'. La veille (ft-v910) on avait ecrit qu'au-dela de 5 g on sort de ce que decrivent les societes savantes ; l'ecran, lui, PROPOSAIT 20 g par defaut. Les deux se contredisaient dans le meme ecran (R2). ⭐ ET LE DEFAUT ETAIT INVISIBLE AUX TESTS parce qu'ils ouvraient toujours la fiche apres avoir choisi une phase. 3 autres corrections : la moyenne « Ou tu en es » comptait le jour EN COURS comme un jour note (donc une moyenne toujours tiree vers le bas des le matin) · l'ecart affiche des 1 jour se lisait comme un reproche → a partir de 3 jours termines, et en gris, pas en orange · le pourcentage de proteines etait plafonne a 100 %, donc quelqu'un a 140 % lisait « 100 % ». ⚠️ Un temoin FAIBLE trouve au passage : son motif attrapait « 100 » dans « 100 % », donc il passait aussi sur l'ancien code plafonne. « OU TU EN ES » RESTAIT FIGEE SUR SON INVITATION. Question de Michel devant l'ecran : « il y a marque note ton premier repas, et par la suite ca engendre quoi ? ». En JOUANT le parcours pour lui repondre, le bug est apparu : on appuie sur le bouton, on note son shaker, on revient sur Macros — et la carte dit toujours « note ton premier repas ». ⚠️ CAUSE : switchNuTab re-rendait le Journal et les Supplements, jamais les Macros. Cet onglet ne contenait, jusqu'a ft-v909, que des chiffres qui ne bougent pas dans la journee — la carte a change ca, et personne ne l'a suivi. La donnee avait change, l'ecran ne le savait pas. ⭐ ET C'EST LA QUESTION DE MICHEL QUI L'A TROUVE : y repondre en JOUANT le parcours plutot qu'en le decrivant. Un ecran se juge le doigt dessus.
const PRECACHE = [
